...
A handful of long tables also reorder slightly: SQL sorts on the text as
written, where Dataview folded case first, so `The Order of Týr's Justice` now
sorts before `The Order of the Ashen Vow`.
