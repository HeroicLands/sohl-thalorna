...
All files not explicitly listed under the Content License section are licensed under GPL-3.0-or-later.

This is the same license, on the same terms, as the Song of Heroic Lands system
this module extends. Thalorna is **original content**: no third-party setting
material enters this repository, and none of it is distributed under any other
publisher's terms.
...
You are free to use, modify, and distribute the source code as long as you also
distribute your changes under the same license.

See the file `LICENSE` in the `src` folder for the full license text. The full license can
also be found at: [https://www.gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)

Each source code file includes a license header.

## Content License

All creative content and documentation in this project—such as game rules, narrative text, lore,
item descriptions, world data, images, icons, video, and other non-code assets—is
licensed under the **Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0)**.

You are free to share and adapt the content as long as you provide attribution and
license your changes under the same terms.
...
- **"SoHL"**
- the **coiled-dragon device** (shipped by the Song of Heroic Lands system at
