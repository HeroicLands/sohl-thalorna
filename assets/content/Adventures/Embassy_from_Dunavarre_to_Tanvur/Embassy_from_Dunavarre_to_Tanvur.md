...
1. **Name:** [[being-thaekliamaelvri|Lady Thaeklia Maelvri]]
...
1. **Name:** [[being-loristaravel|Loris Taravel]]
...
- **Intrigue:** Double agent for Vylaria, manipulates Elowyr to gather sensitive information. Dominant in his secret relationship, he views Elowyr as a useful pawn. Secretly aware of Marric’s role as Spymaster and dismissive of his abilities, Loris feeds false information to Marric to suit his own and Vylaria's objectives.

### Knights

1. **Name:** [[being-arrenthabavel|Sir Arren Thábavel]]
...
**Name:** [[being-marricharavrel|Marric Háravrel]]
...
**Name:** [[being-kadylemcudavel|Kadylem Cúdavel]]

- **Role:** Announces the ambassador’s arrival and status.
- **Background:** Skilled in ceremonial duties and official events.
- **Intrigue:** Closeted romantic interest in Lady Thaeklia, which could be used to manipulate his actions to suit her ambitions.

### Steward

Name: [[being-laradhluavel|Laradh Lúavel]]
...
Name: [[being-nhelynvelthravel|Nhelyn Vélthravel]]

- **Role:** Provides medical care for the party.
- **Background:** Recognized as one of the best physicians and healers in Dúnavarre.
- **Intrigue:** Experimenting with dangerous potions and elixirs, risking the health of the party. His obsession with his research could be exploited.

### Alchemist

Name: [[being-alanoreneavel|Alananor Enéavel]]

- **Role:** Provides medicinal and magical support.
- **Background:** Expert in alchemy and producing necessary potions and remedies.
- **Intrigue:** Feels unacknowledged and underappreciated, leading to resentment. Alananor could be manipulated into betraying the party for recognition.
...
- **Role:** Manages hunting expeditions and scouts surroundings.
- **Background:** Role to be custom-assigned.
...
Name: [[being-rickarluavel|Rickar Lúavel]]

- **Role:** Takes care of the horses and other animals.
- **Background:** Expertise in animal care and handling.
- **Intrigue:** Rickar holds secret sympathies for a rival faction within Dúnavarre. His divided loyalties make him a potential mole within the party.

Players may either take on one of the above roles, replace one of the above roles with their own character, or be a member of the staff of one of those positions.
...
### Connection with Loris of Taravel
...
The party must navigate through time anomalies where a misstep can lead to temporal disorientation.

**Solution:** Using the Temporal Compass to stabilize their path and rituals to align temporal elements. Dryad Guardians:

#### Dryads

Encountering and negotiating or combating Dryads who protect their domain.

**Solution:** Knowledge of Terrae magic and the customs of earth-bound spirits can help players either negotiate safe passage or effectively combat the guardians if necessary.
...
#### The [[place-mazeofechos|Maze of Echoes]]
...
- **Clues Provided:**
  - **Sound-based Navigation:** The party must figure out that certain actions, such as singing or playing specific musical notes, will create echoes that guide them through the shifting passages. Incorrect notes or sounds will lead to dead ends or traps.
  - **Resonant Crystals:** Located throughout the maze are resonant crystals. These must be struck in the correct sequence to produce a harmonious echo that opens hidden doors or reveals the correct path.
  - **Listening to the Environment:** Players need to carefully listen to the changes in the echoes as they move, indicating proximity to the Heart or warning of traps.

### Artifact: The Heart of Dhiríkri

A crystalline artifact believed to hold the essence of the powerful elemental spirits known as Dhiríkri. It emanates an aura that enhances natural growth and can manipulate time within the zone.
