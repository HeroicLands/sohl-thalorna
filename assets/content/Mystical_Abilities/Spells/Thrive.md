...
At higher mastery levels the spell's range extends dramatically and the casting time scales to minutes per acre rather than the full duration, allowing a single mage to tend vast estates. The Land Quality improvement also increases with mastery, making expert earth-mages invaluable to agricultural communities. The effect is instantaneous once cast—the magic permanently alters the soil's composition and microbiome—but it can only be applied once per year to a given plot. Thrive is among the most economically significant spells in the Physéra repertoire, and mages who master it often find themselves courted by lords and village councils alike.
