...
sohl:
  ...
  items:
    ...
    - { shortcode: thrvrdhscrpt, type: skill, system: { masteryLevelBase: 64 } }
    ...
    - { shortcode: mnrl, type: skill, system: { masteryLevelBase: 64 } }
...
2. **Aldric Fallow's Creditors** — A shipment from Caldor has been intercepted by Dúnavarren customs authorities, and among the seized goods are bottles bearing Aldric Fallow's careful labeling. The Ordo Arcanis has noticed. Discreet inquiries are being made. Bélrik must decide whether to distance himself from Aldric Fallow entirely, call in favors from surprising quarters to suppress the investigation, or attempt something far more dangerous: ensuring the evidence disappears before the Ordo can examine it closely.
