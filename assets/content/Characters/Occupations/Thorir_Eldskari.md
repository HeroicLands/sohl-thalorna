...
sohl:
  ...
  items:
    ...
    - { shortcode: clmb, type: skill, system: { masteryLevelBase: 26 } }
    - { shortcode: cmd, type: skill, system: { masteryLevelBase: 28 } }
    - { shortcode: dge, type: skill, system: { masteryLevelBase: 31 } }
