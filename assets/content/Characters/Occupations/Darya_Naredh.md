...
sohl:
  ...
  items:
    ...
    - { model: skill-thrvrdhscrpt, system: { masteryLevelBase: 60 } }
    ...
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 14 } }
    ...
    - { model: sohl-sohl-skill-musc, system: { masteryLevelBase: 64 } }
