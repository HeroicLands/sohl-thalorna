...
sohl:
  ...
  items:
    ...
    - { shortcode: slng, type: skill, system: { masteryLevelBase: 28 } }
    ...
    - { shortcode: aelendlng, type: skill, system: { masteryLevelBase: 32 } }
  system:
    body:
      structure:
        zones:
