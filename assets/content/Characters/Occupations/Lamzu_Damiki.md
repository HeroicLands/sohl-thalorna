...
sohl:
  ...
  items:
    ...
    - { model: skill-hazarscrpt, system: { masteryLevelBase: 75 } }
    ...
    - { model: skill-haradilng, system: { masteryLevelBase: 52 } }
    - { model: sohl-sohl-skill-common, system: { masteryLevelBase: 65 } }
  system:
    body:
      structure:
        zones:
