...
sohl:
  ...
  items:
    ...
    - { shortcode: hrld, type: skill, system: { masteryLevelBase: 62 } }
    ...
    - { shortcode: ritual, type: skill, system: { masteryLevelBase: 30 } }
    - { shortcode: thrvrdhscrpt, type: skill, system: { masteryLevelBase: 55 } }
    - { shortcode: chrm, type: skill, system: { masteryLevelBase: 70 } }
    - { shortcode: cmd, type: skill, system: { masteryLevelBase: 58 } }
    - { shortcode: dscr, type: skill, system: { masteryLevelBase: 72 } }
    - { shortcode: guil, type: skill, system: { masteryLevelBase: 68 } }
...
Her emotional coldness, while operationally useful, has left her without genuine allies. She has associates, clients, and subordinates, but no one who would stand by her out of affection rather than calculation. If her position ever collapses, there will be no one to catch her — only people settling accounts. Her relationship with Dháran is the closest thing she has to a genuine partnership, and even that is ultimately transactional: they respect each other's capabilities and serve the same cause, but neither would hesitate to sacrifice the other if the faith demanded it.
...
4. **The Widow's Suitor** — A prominent nobleman from a neighboring district has begun courting Glýenna, attracted by her competence and the strategic value of a marriage alliance with House Cárdeth. The match would strengthen her public position considerably, but a husband means scrutiny, shared quarters, and the loss of the operational freedom that widowhood provides. She must decide whether the political advantages outweigh the risks to her secret life — and whether the suitor is useful enough to keep or dangerous enough to discourage.
