...
sohl:
  ...
  items:
    ...
    - { shortcode: semrnscrpt, type: skill, system: { masteryLevelBase: 68 } }
    ...
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 17 } }
    ...
    - { shortcode: provnzlng, type: skill, system: { masteryLevelBase: 48 } }
---
