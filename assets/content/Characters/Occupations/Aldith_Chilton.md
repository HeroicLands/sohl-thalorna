...
sohl:
  ...
  items:
    ...
    - { shortcode: cml, type: attribute, system: { scoreBase: 19 } }
    ...
    - { shortcode: thtcs, type: skill, system: { masteryLevelBase: 34 } }
