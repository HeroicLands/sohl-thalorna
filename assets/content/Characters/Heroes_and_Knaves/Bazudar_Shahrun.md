...
sohl:
  ...
  items:
    ...
    - name: Leather harnesses and leads (assorted)
      type: miscgear
      system:
        ...
        value: 100
        durability: 3
    - name: Rope (braided leather and hemp)
      type: miscgear
      system:
        shortcode: rope
        weight: 2
        value: 100
        durability: 3
    - name: Animal feed (grain and dried fodder)
      type: miscgear
      system:
        ...
        value: 100
        durability: 3
    - name: Herbal remedies for animal wounds
      type: miscgear
      system:
        ...
        weight: 1
        durability: 3
    - name: Training whistle and animal calls
      type: miscgear
      system:
