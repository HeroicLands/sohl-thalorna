...
type: being
data:
  portrait: images/beings/characters/cndrthrchrymkhysvr.webp
...
sohl:
  items:
    ...
    - { model: skill-vdykshrscrpt, system: { masteryLevelBase: 45 } }
    ...
    - name: Leather satchel with herbal samples
      type: miscgear
      system:
    ...
    - name: Mortar and pestle
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Glass vials for potions
      type: miscgear
      system:
        shortcode: glassvialsforpotions
        quantity: 12
        weight: 1.5
        value: 100
        durability: 3
...
- **Perception and Insight**: With perception as his highest attribute, Càndrathar reads people with precision. He discerns truth from falsehood, desperation from casual interest, and the hidden motives behind polite requests.
...
- **Physical Fragility**: Years of exposure to toxic fumes, poisons, and concentrated herbal compounds have weakened his endurance. He is not a fighter; direct physical confrontation is beyond his capability.
...
5. **The Healer's Redemption**: A desperate family arrives bearing a poisoned family member—but the poison is no work of professional craft. It is clumsy, obvious, and wrong in nearly every way. Yet it is poison that Càndrathar is known to have created and sold. He is certain the poisoning was committed by someone else, likely an ambitious apprentice or a copycat, yet proof will be nearly impossible to establish. The family's patriarch is powerful and politically connected; he is already spreading word that Càndrathar attempted to murder him. Càndrathar must either identify the true poisoner and prove his own innocence, or accept that his darker career is about to consume his legitimate reputation and freedom in Vedyara.
