...
sohl:
  ...
  items:
    ...
    - { model: skill-demtkscrpt, system: { masteryLevelBase: 75 } }
    ...
    - { model: sohl-sohl-armorgear-ecloak }
    - { model: sohl-sohl-armorgear-vhat }
    - name: Embroidered silk bag (ornate, hand-sewn)
      type: miscgear
      system:
        shortcode: embroideredsilkbag
        weight: 1
        value: 100
        durability: 3
    - name: Elegant gown (additional formal dress)
      type: miscgear
      system:
        shortcode: elegantgown
        quantity: 1
        weight: 1
        value: 100
        durability: 3
    - name: Books (philosophical and romantic texts)
      type: miscgear
      system:
        shortcode: books
        quantity: 3
        ...
        value: 100
        durability: 3
    - name: Calligraphy set (brushes, inks, papers)
      type: miscgear
      system:
        shortcode: calligraphyset
        weight: 1
        value: 100
        durability: 3
    - name: Jewelry and cosmetics
      type: miscgear
      system:
        shortcode: jewelryandcosmetics
        quantity: 2
        weight: 1
        value: 100
        durability: 3
    - name: Scent bottles (perfumes and oils)
      type: miscgear
      system:
        shortcode: scentbottles
        quantity: 2
        weight: 1
        value: 100
        durability: 3
...
- **Keen Perception and Awareness**: With perception at 14 and awareness at 14, she notices the smallest details—a trembling hand, an avoided gaze, the pause before a lie. Few secrets remain hidden from her observation.

- **Physical Grace and Agility**: Her agility (15) and dancing (15) are legendary among the noble courts. She moves with such fluidity that observers find themselves mesmerized, and she can navigate treacherous situations—both literal and social—with remarkable poise.

- **Artisan of Words**: Her talents in singing (16), script (15), and theater (15) allow her to craft narratives, forge documents when needed, and present versions of truth that are difficult to refute. She understands language as both art and weapon.
...
- **Reputation Fragility**: Despite her current position, she remains haunted by her past scandal. New revelations or political shifts could destabilize everything she has built. This knowledge makes her overly cautious and sometimes paralyzes her in moments when bolder action might serve her better.

- **Physical Vulnerability**: Her strength is only 8, among her lowest attributes. She is not built for direct confrontation and cannot win through physical force, making her dependent on allies for protection in dangerous situations.

- **Limited Survival Skills**: While she possesses survival (14) academically, she is truly a creature of civilization. Without servants, luxuries, and structured society, she quickly becomes uncomfortable. Wilderness terrifies her.
...
3. **The Competitor's Peril**: A wealthy patron who has recently begun shifting his attention from Tamiyra to her rival Selena Moros asks Tamiyra to help him understand why Selena is suddenly refusing his advances. When Tamiyra investigates, she discovers Selena has been captured and imprisoned by persons unknown, forced into servitude far from Ta'Kheperu. Despite their professional rivalry, Tamiyra must decide whether to risk her own position attempting a rescue, or whether to use the situation to eliminate her competition permanently.

4. **The Encrypted Archive**: While researching a potential new patron's background, Tamiyra discovers references to a secret archive hidden within the imperial archives—a collection of forbidden documents, love letters, and political intelligence gathered over centuries. Multiple factions are searching for it, and they believe she has knowledge of its location because her father worked in the archives. She must navigate between those who would kill for the information and those who would pay kingdoms to suppress it.

5. **The Scribe's Redemption**: An elderly scribe named Pthahotep, who once worked alongside Tamiyra's father, approaches her with a deathbed confession. He claims that the scandal that nearly destroyed her was not orchestrated by enemies but by her own mother, as part of a larger scheme to protect Tamiyra from something far more dangerous. He cannot fully explain before he dies, but leaves her with a cryptic journal that suggests a dark truth about her early life, her family's loyalties, and her connection to something the imperial court would kill to keep secret.
