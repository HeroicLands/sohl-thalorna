...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 10 } }
    ...
    - name: Sailor’s rope (braided, coiled)
      type: miscgear
      system:
    ...
    - name: Personal journal (sailing records)
      type: miscgear
      system:
        shortcode: personaljournal
        weight: 0.3
        value: 100
        durability: 3
