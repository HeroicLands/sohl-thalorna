...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-thtcs, system: { masteryLevelBase: 39 } }
    ...
    - name: Wooden weapon case (sturdy construction)
      type: miscgear
      system:
        shortcode: woodenweaponcase
        weight: 1
        value: 100
        durability: 3
    - name: Practice foils (padded, 3)
      type: miscgear
      system:
        shortcode: practicefoils
        weight: 1
        value: 100
        durability: 3
    - name: Leather fencing mask
      type: miscgear
      system:
        shortcode: leatherfencingmask
        weight: 1
        value: 100
        durability: 3
    - name: Instructional manuals on the Path of Breath
      type: miscgear
      system:
        shortcode: instructionalmanuals
        weight: 1
        value: 100
        durability: 3
...
- **Tactical Combat Intelligence**: Perception of 15, awareness of 15 (×3), and command skills allow her to read battlefield situations with remarkable clarity and lead others with quiet confidence.
- **Physical Excellence**: Her strength of 13 combined with her exceptional dexterity and agility gives her an optimal balance of power and speed. Initiative at 14 (×4) means she nearly always acts first in combat.
- **Scholarly Understanding**: Heraldry (13, ×5), law (13, ×1), and discourse skills (13, ×4) give her deep knowledge of formal dueling codes, noble lineages, and rhetoric, allowing her to navigate high society with surprising effectiveness.
...
- **Competitive Obsession**: Her drive to test herself against stronger opponents has led her into situations that endangered her reputation or safety. She is vulnerable to challenges that manipulate her pride.
- **Limited Empathy**: While she genuinely cares about her students' development, she has limited ability to understand emotional distress or to provide comfort to those suffering from non-martial difficulties. Her advice, while wise, can seem cold and dismissive of emotional concerns.
...
2. **The Poisoned Student**: One of her most promising students, **Lord Cassian**, falls mysteriously ill with a poison that no physician can identify or cure. As Korêmdânis investigates, she discovers evidence suggesting he was poisoned not by an enemy but by a rival student jealous of his progress. This discovery forces her to confront the possibility that her teachings, taken to extremes, could create monsters—and that she bears some responsibility for her students' moral choices.

3. **The Imperial Succession Crisis**: The Emperor dies without a clear heir, and several claimants to the throne emerge. A faction supporting one of the claimants approaches Korêmdânis, offering her enormous wealth and power if she will publicly endorse their candidate. Her endorsement would likely determine the succession, making her responsible for the future of the Empire. She must navigate political intrigue that threatens to embroil her in conflict far beyond her control.

4. **The Betrayal of the Path**: An ancient text surfaces suggesting that the Path of Breath was originally taught by a mystical order now lost to history, and that true mastery requires spiritual practices beyond martial training. A mysterious wanderer named **the Ascetic** appears in Vald and challenges Korêmdânis's understanding of the path she's devoted her life to mastering. Korêmdânis must journey with this mysterious teacher to discover whether she's been incomplete in her pursuit of mastery.

5. **The Master's Retirement**: Swordmaster Valdis, Korêmdânis's ancient teacher and the only person she truly respects, approaches his end. He summons her to his deathbed and reveals that he has identified an heir—another student with potential matching her own. Valdis requests that Korêmdânis train this heir, passing on his legacy. But the heir is trained in a rival tradition, and Korêmdânis questions whether compromising her pure approach to teaching would betray everything Valdis taught her about integrity.
