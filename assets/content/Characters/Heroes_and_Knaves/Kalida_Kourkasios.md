...
sohl:
  ...
  items:
    ...
    - name: Potter's wheel (portable, artist-grade)
      type: miscgear
      system:
        shortcode: potterswheel
        weight: 3
        value: 12
        durability: 3
    - name: Kiln-firing tools and temperature gauges
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Assorted ceramic glazes (sealed containers)
      type: miscgear
      system:
        ...
        value: 20
        durability: 3
    - name: Selection of brushes and carving tools
      type: miscgear
      system:
        shortcode: selectionofbrushes
        weight: 0.5
        value: 100
        durability: 3
    - name: Sketchbook and drawing materials
      type: miscgear
      system:
        shortcode: sketchbookanddrawing
        weight: 0.6
        value: 100
        durability: 3
    - name: Clay samples (various sources)
      type: miscgear
      system:
        shortcode: claysamples
        weight: 1.2
        value: 100
        durability: 3
...
- **Compelling Marketer**: Her Charm at 15 and Theatrics at 15 allow her to sell her work effectively, despite (or because of) the premium prices she commands.
...
- **Financial Instability**: Despite earning well, she spends impulsively on materials and experiments, sometimes leaving herself short of funds despite her reputation.
