...
sohl:
  ...
  items:
    ...
    - { model: skill-thuravarkscript, system: { masteryLevelBase: 52 } }
    ...
    - name: Wooden box for scrolls
      type: miscgear
      system:
        shortcode: woodenboxforscrolls
        weight: 0.5
        value: 100
        durability: 3
    - name: Runestones for divination
      type: miscgear
      system:
        shortcode: runestones
        quantity: 1
        weight: 1
        value: 100
        durability: 3
    - name: Ceremonial drinking horn
      type: miscgear
      system:
        shortcode: ceremonialdrinking
        weight: 0.4
        value: 100
        durability: 3
    - name: Lute or harp (musical instrument)
      type: miscgear
      system:
        shortcode: luteorharp
        weight: 2
        value: 100
        durability: 3
...
2. **The Succession Crisis**: Upon the death of a prominent noble patron, Vígbrandr is contracted to perform at the funeral rites and publicly validate the new heir's legitimacy through recitation of the family genealogy. However, adventurers discover evidence that the new heir is not of true blood, and they must decide whether to expose this before Vígbrandr's performance—which will make the succession fact in the eyes of the kingdom—or to allow the false heir to take power. Vígbrandr himself becomes entangled in their moral dilemma, torn between his role as authenticator and his growing suspicion that something is amiss.

3. **The Challenge of the Gifted Youth**: A prodigiously talented young skald, barely twenty winters old, publicly challenges Vígbrandr to a performance contest, claiming that traditional methods are beautiful but obsolete, and that her innovative approach will move the hearts of audiences more profoundly. Vígbrandr is desperate to prove himself but increasingly aware of his own limitations as age creeps upon him. The party becomes involved as the contest escalates, potentially serving as judges or mediators as both skalds push themselves to their limits, forcing Vígbrandr to confront whether his pride in tradition is justified or merely self-deception.

4. **The Lost Archive**: Vígbrandr receives word that a destroyed monastery once housed an archive of ancient sagas that predates his own understanding, and the fragments have been discovered in the possession of a reclusive scholar in the mountains. Despite his assertions that he possesses all authentic tales, his hunger for knowledge and fear that significant narratives may have been lost drives him to hire adventurers to locate and retrieve these fragments. The journey becomes complicated when they discover that the "lost sagas" tell stories that contradict the great houses' official histories, and multiple factions begin hunting the archive to either preserve or destroy it.

5. **The Imposter's Gambit**: A skilled performer emerges in a distant city, performing "ancient sagas" that are actually Vígbrandr's own compositions and interpretations, claiming to be an undocumented cousin of the legendary skald. The imposter gathers significant fame and patronage, and Vígbrandr's attempts to expose the fraud are thwarted when the imposter produces documents suggesting Vígbrandr himself may be the false claimant to the Skýrekkr name. Caught in a web of authentication and identity, Vígbrandr must work with the party to uncover the truth, all while his reputation hangs by a thread and younger skalds circle like vultures, sensing weakness in their elder.
