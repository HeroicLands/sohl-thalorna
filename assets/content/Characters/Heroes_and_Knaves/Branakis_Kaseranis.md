...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-mnrl, system: { masteryLevelBase: 22 } }
    ...
    - name: Kiln maintenance tools (shovel, rake, poker)
      type: miscgear
      system:
        shortcode: kilnmaintenancetools
        weight: 2
        value: 100
        durability: 3
