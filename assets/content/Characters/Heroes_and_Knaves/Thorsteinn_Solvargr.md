...
type: being
data:
  portrait: images/beings/characters/thrstnslvrgr.webp
...
sohl:
  items:
    ...
    - { model: sohl-sohl-skill-mnrl, system: { masteryLevelBase: 65 } }
    ...
    - { model: sohl-sohl-skill-cmcs, system: { masteryLevelBase: 56 } }
    - { model: sohl-sohl-skill-draw, system: { masteryLevelBase: 26 } }
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 65 } }
    - { model: sohl-sohl-skill-mtlc, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-skill-txtl, system: { masteryLevelBase: 28 } }
    - { model: sohl-sohl-skill-wood, system: { masteryLevelBase: 14 } }
...
- **Emotional Detachment** - His professional reserve sometimes extends into personal relationships. His wife has remarked that he seems to give more affection to his work than to the people in his life.
...
3. **The Archaeological Fragment**: - While working with materials delivered to his workshop, Thorsteinn discovers fragments of ancient glasswork—masterpieces from centuries past that suggest technical methods and aesthetic approaches that seem completely foreign to modern knowledge. He becomes obsessed with understanding how these pieces were created, realizing that perhaps his entire approach to glassworking is based on incomplete knowledge, and that what he thought was established tradition might actually be a degradation of more sophisticated ancient practices.
