...
sohl:
  ...
  items:
    ...
    - { model: skill-demtkscrpt, system: { masteryLevelBase: 42 } }
    ...
    - name: Lyre or harp (fine instrument)
      type: miscgear
      system:
        shortcode: lyreorharp
        weight: 3
        value: 300
        durability: 4
    - name: Notebook for lyrics and compositions
      type: miscgear
      system:
        shortcode: notebookforlyrics
        weight: 1.5
        value: 200
        durability: 3
    - name: Healing herbs and poultices
      type: miscgear
      system:
...
The tragedy that scarred his face forever transformed his art. During a grand performance at a noble's estate when he was merely twenty-three winters old, a drunk reveler—the jealous husband of a woman Pasher had befriended—lunged at him with a knife mid-song. The blade caught him across the eye, and for months Pasher lay fevered and uncertain whether he would ever see again from that eye. He did recover, though the scar remained, and more importantly, the experience taught him that true music speaks to the deepest wells of human emotion. His songs thereafter became more genuine, more vulnerable, reaching souls in ways mere technical perfection could never achieve. The scar became his badge of authenticity.
...
- **Lyricist and Composer**: Beyond performance, Pasher creates original songs that capture the essence of stories and emotions in ways that move audiences deeply. His notebook is filled with lyrics of remarkable beauty and poignancy.

- **Emotional Resonance**: He possesses an almost supernatural ability to sense the mood and needs of a crowd, shifting his performance to speak directly to their hearts. This has made him beloved among common folk who see in his songs reflections of their own struggles.

- **Persuasive Presence**: His genuine interest in people and his warmth make him a natural diplomat and peacemaker. Many conflicts have been soothed by his intervention and his willingness to hear all sides.
...
- **Court Politics Bewilderment**: The formalities of noble courts baffle and frustrate him. He often says the wrong thing, fails to understand subtle insults, and shows little patience for courtly intrigue.

- **Physical Vulnerability**: While not unskilled with a blade, he is not a warrior. His scar serves as a constant reminder of his vulnerability, and he prefers to flee danger rather than face it.

- **Restless Judgment**: His wandering nature sometimes manifests as contempt for those who have chosen to remain in one place, as if he sees their stability as a failure of imagination or courage.
...
- **Lord Amenhotep of the Eastern Reaches**: A provincial lord who has competed with other nobles for the privilege of hosting Pasher's performances. He values Pasher's ability to enhance the prestige of his court and treats the musician with unusual respect and generosity.
...
2. **The Thief of Melodies**: Pasher's greatest work, a song cycle he spent years composing called "The Descent of Wasetkara," has been stolen. A merchant caravan carrying his belongings while he traveled overland was ambushed, and all his notebooks and original compositions were taken. He has since learned that the pieces are being performed throughout the western provinces by an unknown musician claiming them as original work. Worse, this thief is a genuinely gifted performer—some who have heard both versions claim they prefer the thief's interpretations. Now Pasher must track down this mysterious rival, and he fears what he will learn about the nature of art and ownership when he finally finds them.
