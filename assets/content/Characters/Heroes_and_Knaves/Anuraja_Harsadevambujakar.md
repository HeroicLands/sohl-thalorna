...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-anmcft, system: { masteryLevelBase: 10 } }
    ...
    - name: Lockpicks and specialized tools
      ...
      system:
        ...
        value: 5
        durability: 3
    - name: Poisons (assorted compounds)
      type: miscgear
      system:
        shortcode: poisons
        quantity: 4
        ...
        weight: 1
        durability: 3
    - { model: sohl-sohl-miscgear-grphook }
    - name: Climbing gloves (leather)
      type: miscgear
      system:
        shortcode: climbinggloves
        weight: 1
        value: 100
        durability: 3
    - name: Garotte wire (concealed)
      type: miscgear
      system:
        shortcode: garottewire
        weight: 1
        value: 100
        durability: 3
...
In professional contexts, he is meticulous to the point of obsession. Every contract is researched exhaustively; every variable is planned for; every contingency is prepared. He is willing to abandon lucrative assignments if conditions suggest risk inadequately compensated by payment. This rational detachment has allowed him to survive longer than most assassins—he takes calculated risks, never personal vendettas.
...
Fundamentally, Anûraja is motivated by the philosophical principles he absorbed during his training—the belief that the world contains too many people, that selective elimination creates balance, that some individuals are threats that must be neutralized for the greater good. He performs his work not as mere murder-for-hire, but as a kind of darker priesthood, maintaining equilibrium through careful elimination of destabilizing elements.
...
- **Master Climbing and Acrobatics**: His climbing skill of 17 base with three specializations and his dancing skill of 16 allow him to navigate vertical spaces others consider impassable. He can scale walls, traverse rope bridges, and position himself in impossible locations.
- **Advanced Creative Problem-Solving**: A creativity score of 17 gives him the capacity for innovative approaches to assassination problems. When conventional methods are blocked, his mind quickly generates alternatives.
- **Stealth Mastery**: His stealth, awareness, and tracking capabilities allow him to observe without being observed and to move through spaces without disturbing them. He can infiltrate secure locations and observe targets for weeks without detection.
...
- **Limited Empathy**: His empathy score of 9 means he cannot reliably predict how people will react to emotional appeals or why some individuals value concepts like loyalty or family above survival.
- **Overconfidence**: His perfect record has created a dangerous certainty that he can execute any contract. This confidence occasionally leads him to accept commissions that contain hidden variables.
...
2. **The Betrayal Revealed**: An intelligence asset Anûraja has relied upon for verification of contracts turns out to have been feeding him false information. One of his previous "assignments" was actually an innocent person whose death was arranged by a rival assassin attempting to frame him. The revelation that he has broken his own code—killing the wrong target—sends psychological shockwaves through his carefully ordered existence. He begins investigating who manipulated him and why, determined to correct the error.

3. **The Mentor's Ultimatum**: **Grandmother Vex** approaches Anûraja directly with an offer rather than an attempt at assassination. She reveals that she is dying and wishes to pass her knowledge to a successor. She believes Anûraja has strayed from the true path of shadow-work, but thinks he can be redeemed. She offers him a choice: spend six months in intensive retraining under her supervision, learning the "philosophy" he abandoned, or face her as an enemy knowing she will dedicate her final years to his elimination.

4. **The Conscience Awakens**: A contract goes catastrophically wrong when Anûraja discovers the target is a young woman bearing an uncanny resemblance to his sister—a sister he believed dead in childhood. Investigation reveals that his sister may have survived, that this target may actually be his sister, and that someone deliberately arranged this contract knowing it would create exactly this moral crisis. Forced to confront the possibility of genuine family connection, Anûraja must navigate unfamiliar emotional territory while determining whether the resemblance is coincidence, manipulation, or truth.

5. **The Sacred Weapon**: A wealthy collector approaches Anûraja with an unusual proposition: not a contract for murder, but a commission to acquire a legendary artifact—a blade of such craftsmanship and alleged supernatural properties that its mere possession has sparked wars. The artifact is currently in the hands of a military order that will defend it to the death. Anûraja must employ assassination, theft, and manipulation in concert to obtain the blade, all while realizing that the artifact is exactly what his mentor **Grandmother Vex** has been seeking, and that she will kill him to possess it.
