...
sohl:
  ...
  items:
    ...
    - { shortcode: timb, type: skill, system: { masteryLevelBase: 70 } }
    ...
    - name: Woodworking tools (chisels, gouges, knives, planes)
      type: miscgear
      system:
        weight: 2.5
        value: 100
        durability: 3
    - name: Woven basket for tool transport
      type: miscgear
      system:
        weight: 1.2
        value: 100
        durability: 3
    - name: Measuring tape and rule
      type: miscgear
      system:
        weight: 0.5
        value: 100
        durability: 3
    - name: Book of tree identification and lore
      type: miscgear
      system:
        weight: 1
        value: 100
...
- **Practical Wisdom**: Understands the seasons, weather patterns, and forest ecology that determine the best times and places to harvest timber.
...
- **Limited Social Grace**: Her blunt assessment of others' work—accurate though it may be—creates enemies among those with thinner skin.
