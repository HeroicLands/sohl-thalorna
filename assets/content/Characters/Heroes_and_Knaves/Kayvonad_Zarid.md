...
sohl:
  ...
  items:
    ...
    - { model: skill-dnshkscrpt, system: { masteryLevelBase: 75 } }
    ...
    - name: Laboratory notes and formulae (extensive)
      type: miscgear
      system:
        shortcode: laboratorynotes
        weight: 1.5
        value: 100
        durability: 3
    - name: Rare mineral samples (lead, silver, precious compounds)
      type: miscgear
      system:
        shortcode: raremineralsamples
        weight: 1.5
        value: 100
        durability: 3
    - name: Alchemical apparatus tools
      type: miscgear
      system:
        shortcode: alchemicalapparatus
        weight: 2
        value: 50
        durability: 4
    - name: Measuring scales and weights
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Crucibles and distillation vessels (small)
      type: miscgear
      system:
        shortcode: crucibles
        weight: 1.5
