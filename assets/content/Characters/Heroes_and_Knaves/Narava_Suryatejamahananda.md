...
sohl:
  ...
  items:
    ...
    - { model: skill-vdykshrscrpt, system: { masteryLevelBase: 42 } }
    ...
    - name: Tongs (various weights)
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Colored glass powders
      type: miscgear
      system:
        shortcode: coloredglasspowders
        quantity: 5
        weight: 1
        value: 100
        durability: 3
    - name: Heat-resistant leather gloves
      type: miscgear
      system:
        shortcode: heatresistantleather
        weight: 1
        value: 100
        durability: 3
    - { model: sohl-sohl-miscgear-tndrbx }
    - name: Sketch materials (charcoal, parchment)
      type: miscgear
      system:
        shortcode: sketchmaterials
        weight: 1
        value: 100
        durability: 3
