...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-glas, system: { masteryLevelBase: 75 } }
    ...
    - name: Wooden crate for glass supplies and tools
      type: miscgear
      system:
        shortcode: woodencrateforglass
        weight: 2
        value: 100
        durability: 3
    - name: Glass cutters and scoring tools
      type: miscgear
      system:
        shortcode: glasscutters
        weight: 0.5
        value: 100
        durability: 3
    - name: Colored glass pieces (assorted)
      type: miscgear
      system:
        shortcode: coloredglasspieces
        quantity: 2
        weight: 1
        value: 100
        durability: 3
    - name: Metal frames and leads for window assembly
      type: miscgear
      system:
        shortcode: metalframesandleads
        weight: 0.8
        value: 100
        durability: 3
    - name: Glass polishing and smoothing tools
      type: miscgear
      system:
        shortcode: glasspolishing
        weight: 1
        value: 100
        durability: 3
    - name: Furnace materials and fusing supplies
      type: miscgear
      system:
        shortcode: furnacematerials
        weight: 1
        value: 100
        durability: 3
...
- **Extraordinary Technical Skill**: Her glassworking (15 with 5 specializations), dexterity (16), and perception (15) allow her to execute her artistic visions with precision. Her hands are instruments of remarkable capability, capable of manipulating glass with both delicacy and strength.

- **Innovative Problem-Solving**: Her reasoning (13) and high creativity allow her to develop novel techniques and solutions to technical challenges. She has invented several new approaches to glass manipulation that other artisans have since adopted.

- **Physical Grace and Awareness**: Her agility (13), climbing (14), and awareness (14) make her comfortable working at heights and in awkward positions. She is fearless when working on large installations.
...
- **Sensitivity to Criticism**: While intellectually aware that critique is necessary for growth, she takes critical feedback personally and can become defensive or paralyzed by it. A negative response to her work can discourage her for weeks.

- **Emotional Isolation**: Her guile (15) and intrigue abilities (14), while useful professionally, have made her excellent at maintaining emotional distance. This has prevented meaningful relationships and leaves her chronically lonely, though she rarely admits this.

- **Commercial Naïveté**: Her reasoning (13), while sufficient for technical matters, leaves her vulnerable to being exploited in business dealings. She sometimes accepts commissions at rates that undervalue her work and struggles with client negotiations.
...
- **Merchant Collector Lady Esther Whitmore**: A wealthy widow with sophisticated aesthetic tastes who has commissioned several major pieces for her private manor. She appreciates Thalísa's innovation and has paid premium prices for original works.
...
2. **The Lost Master's Final Work**: While exploring an abandoned cathedral, Thalísa discovers fragmentary remains of glasswork by Master Aldwin that she has never encountered—work showing him experimenting with techniques that parallel her own innovations, suggesting he was moving in similar directions before his death. Investigation reveals he may have destroyed some of his work to avoid criticism, and other pieces may still be hidden. She becomes obsessed with finding these missing works and understanding what her mentor was truly trying to achieve.

3. **The Architectural Opportunity**: Thalísa receives an invitation to submit designs for windows in a major civic building—an once-in-a-lifetime commission that could establish her as a major artist. However, the competition includes Master Helmut Thorne and other traditionalists, and the selection committee appears biased toward conventional work. She must decide whether to compromise her artistic vision to compete fairly or to submit her true vision and risk rejection, potentially damaging her reputation.

4. **The Cursed Glass**: Thalísa acquires an unusual sample of glass—ancient, with unusual properties and coloration—from a collector's estate. When she begins working with it, creating extraordinary windows infused with the material, people who view the completed windows report disturbing dreams, visions, or compulsions. She must determine whether the glass is truly cursed or if something about her art is unlocking susceptibilities in viewers, and whether she should destroy the completed work or reveal its effects.

5. **The Rival's Accident**: Cassian Darkglass, her estranged former student, is seriously injured in a workshop accident—injuries so severe that he may never work again. Initially viewing this as his burden to bear, Thalísa gradually learns that his accident may not have been accidental and that multiple parties had reason to wish him harm. More troublingly, some evidence suggests the incident may have been meant for Thalísa herself. She must uncover who sought to harm whom and why, discovering conspiracy threads that implicate some she trusted.
