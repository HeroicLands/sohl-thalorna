...
type: being
data:
  portrait: images/beings/characters/skfrnstrmrt.webp
...
sohl:
  items:
    ...
    - name: Needle and thread (multiple types)
      type: miscgear
      system:
        shortcode: needleandthread
        quantity: 3
        weight: 1
        value: 100
        durability: 3
    - name: Fabric dyes (powdered)
      type: miscgear
      system:
        shortcode: fabricdyes
        quantity: 2
        weight: 1
        value: 100
        durability: 3
    - name: Small portable loom
      type: miscgear
      system:
        shortcode: smallportableloom
        weight: 1.2
        value: 100
        durability: 3
    - name: Cloth swatches and samples
      type: miscgear
      system:
        shortcode: clothswatches
        weight: 1
        value: 100
        durability: 3
    - name: Measuring tape and shears
      type: miscgear
      system:
        shortcode: measuringtape
        weight: 1
        value: 100
        durability: 3
...
She is ambitious in an artistic sense—not seeking power or wealth but recognition that her work equals that of the great painters, sculptors, and craftspeople of the realm. She views each commission as an opportunity to advance her technique and prove that textiles are capable of conveying the same aesthetic sophistication as more "elevated" arts. She can be frustrated by clients who want beauty but refuse to pay the price such artistry demands, or who compromise her vision for practicality.
...
- **Innovative Design**: While rooted in traditional forms, **Skúfrún's** designs push boundaries, incorporating techniques and combinations that are genuinely novel. Her work frequently becomes copied by lesser artisans attempting to replicate her success.
...
- **Intolerance for Compromise**: When clients request changes that contradict her artistic vision, **Skúfrún** struggles to accept them gracefully. She may comply but will do so with visible resentment, damaging client relationships.
...
2. **The Dye Master's Curse**: **Skúfrún** acquires an extraordinary batch of ancient dye formulae from a deceased artisan's estate—colors so vivid and beautiful that they seem almost supernatural. She begins using them in her finest work, creating pieces of breathtaking magnificence. However, clients report strange occurrences: garments dyed with these colors seem to attract attention compulsively (wearers are drawn to wearing them constantly), or colors seem to shift in emotionally resonant ways (crimson fading to pale pink in moments of sadness, brightening in joy). **Skúfrún** realizes the dyes are not merely pigment but are somehow infused with the aesthetic will of their creator—a mage who encoded her personality and intentions into the formulations before her death. The dyes are magnificent but potentially dangerous. **Skúfrún** must decide whether to continue using them (abandoning her commitment to pure art), destroy them (wasting irreplaceable materials), or attempt to understand the dead mage's intentions and perhaps communicate with her through the dyes themselves.

3. **The Commissioned Lie**: A wealthy merchant approaches **Skúfrún** with a specific and unusual request: create a costume and banner that perfectly mimics the heraldry and dress of a rival merchant's house, so convincing it can be used to infiltrate events and steal proprietary secrets. The merchant offers an extraordinary sum—enough to secure her workshop's future and expand significantly. He presents it as a victimless deception in merchant competition. **Skúfrún's** artistic sensibilities are genuinely attracted to the technical challenge of perfect mimicry. But as she works, she begins to understand that the true target is not merely business espionage but potentially theft with violent consequences. She must navigate the tension between her desire to accept an incredible commission and her growing moral concern about how her beautiful deception will be weaponized.

4. **The Tapestry That Shows the Future**: **Skúfrún** accepts a commission to create a massive tapestry depicting a historical battle, commissioned by a noble commemorating his family's military victory. As she works, weaving the detailed scene, she discovers something impossible: certain patterns seem to move of their own accord, and imagery she swears she didn't intentionally create appears in the weave. The tapestry appears to be depicting not only the past battle but a future one—a conflict that seems about to unfold, with startlingly accurate detail. When nobles viewing the work-in-progress recognize themselves (or their children) depicted in roles suggesting their deaths or betrayals, panic spreads. **Skúfrún** must determine whether her art has somehow become prophetic, whether the tapestry is haunted, or whether she herself is channeling information she has no conscious access to.

5. **The Gender Challenge**: A prestigious guild competition is announced for the finest craftspeople in Malagna, with the winner receiving unprecedented recognition and a position at the royal court. **Skúfrún** eagerly prepares her best work, only to discover that the competition is restricted to male artisans—a traditional rule never before questioned. When she attempts to enter under an assumed masculine name, she is discovered and publicly humiliated. The incident sparks broader discussion about women's roles in craft trades, with some supporting her and others defending tradition. **Skúfrún** must decide whether to fight the rule through politics and advocacy (potentially alienating conservative patrons and the guild hierarchy), accept the exclusion and prove her worth through continued brilliant work, or take a path of artistic rebellion that might sacrifice her commercial success for artistic principle.
