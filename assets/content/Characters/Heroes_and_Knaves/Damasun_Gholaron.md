...
sohl:
  ...
  items:
    ...
    - { shortcode: dscr, type: skill, system: { masteryLevelBase: 46 } }
    ...
    - { shortcode: shok, type: skill, system: { masteryLevelBase: 64 } }
    ...
    - { shortcode: archery, type: skill, system: { masteryLevelBase: 88 } }
