...
sohl:
  ...
  items:
    ...
    - { model: sohl-sohl-skill-mnrl, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-srvl, system: { masteryLevelBase: 12 } }
    - { model: sohl-sohl-skill-timb, system: { masteryLevelBase: 26 } }
    ...
    - name: Leather worker's knives and tools
      type: miscgear
      system:
        shortcode: leatherworkersknives
        weight: 1
        value: 100
        durability: 3
    - name: Tanning supplies (lime, alum, salts)
      type: miscgear
      system:
        shortcode: tanningsupplies
        quantity: 3
        weight: 1
        value: 100
        durability: 3
    - name: Dyes and stains
      type: miscgear
      system:
        shortcode: dyesandstains
        quantity: 4
        weight: 1
        value: 100
        durability: 3
    - name: Stitching tools (needles, thread, waxed cord)
      type: miscgear
      system:
        shortcode: stitchingtools
        weight: 1
        value: 100
        durability: 3
    - name: Scrapers and finishing tools
      type: miscgear
      system:
        shortcode: scrapersandfinishing
        weight: 1
        value: 100
        durability: 3
    - name: Oil and conditioning compounds
      type: miscgear
      system:
        shortcode: oilandconditioning
        weight: 1
        value: 100
        durability: 3
...
At thirty-three, a moment of inattention with a splitting knife nearly cost Gârlen his leg. The blade slipped, opened his thigh and calf nearly to the bone, and left him fevered and delirious for a month while a physician named **Cútheir** fought the wound's infection with poultices and prayer. Gârlen recovered, though imperfectly—the leg never regained its full strength, and he walks with a subtle limp that occasionally aches during damp seasons. More significantly, the incident shattered his confidence. For two years, he worked only simple projects, terrified of another mistake. Only through the patient encouragement of **Cútheir** and his regular customers did he gradually rebuild his skill and his nerve.
...
- **Deep Practical Knowledge**: He understands animal husbandry, the characteristics of different creatures' hides, the properties of various tanning solutions, and the subtle interplay between materials. This knowledge extends to related crafts like textilework and basic leatherwork enhancement.
...
- **Limited Business Acumen**: He struggles with the financial aspects of his trade—pricing, negotiation, maintaining margins—leaving him perpetually slightly less wealthy than his skill would suggest he should be.
...
2. **The Poisoned Batch**: Several of Gârlen's recent customers fall mysteriously ill with a condition that no physician can identify—all the victims share only one connection: they purchased leather goods from Gârlen's workshop within the past three months. Gârlen is devastated and immediately suspects that his materials have been contaminated, but investigation suggests something far more sinister—someone has deliberately adulterated leather shipments intended for Gârlen, trying to frame him and destroy his reputation. The party must uncover the culprit before Gârlen's business is destroyed. The investigation leads to **Torvin**, his rival, who is willing to commit murder to eliminate competition.

3. **The Apprentice's Secret**: Gârlen's talented apprentice **Ariel** begins to act strangely, occasionally disappearing for entire days. When confronted, she reveals that she has been secretly meeting with a black-market fence who has been hiring her to create specialized leather containers for smuggled goods. She owes them a substantial debt and fears what they will do if she refuses. Gârlen must decide whether to turn her over to the authorities or to help her escape her obligations. If he helps, the party becomes entangled in conflict with organized crime. If he turns her in, he may destroy the talented apprentice he has hopes to train into a master craftsperson.

4. **The Master's Masterwork**: As age begins to creep upon him, Gârlen commits to creating one final masterwork—a complete set of ceremonial leather armor of breathtaking complexity and beauty. He offers the party a substantial commission: find him a specific material he requires—the hide of a **shadowreaver**, a nocturnal predator rumored to inhabit the deepest forests. The quest to hunt this creature becomes an adventure in itself, testing whether the party can obtain a hide worthy of a true master craftsman. Upon completion, the armor is so extraordinary that nobility and warlords begin bidding for it, potentially changing Gârlen's life—or attracting dangerous attention.

5. **The Injured Warrior's Salvation**: A famous warrior or knight arrives at Gârlen's workshop bearing a grievous wound on their dominant leg—one that threatens to end their adventuring career. **Cútheir**, now very elderly, recommends that the warrior seek Gârlen's help, suggesting that his experience with his own injury recovery might provide physical therapy insight, and that wearing custom-crafted supportive leather garments might enable the warrior to return to active life. Gârlen is initially reluctant—he is a craftsman, not a healer—but he begins designing specialized leather supports that allow the warrior graduated return to function. The party might need to protect Gârlen from enemies of the warrior, or assist in testing the efficacy of his designs in actual adventuring scenarios.
