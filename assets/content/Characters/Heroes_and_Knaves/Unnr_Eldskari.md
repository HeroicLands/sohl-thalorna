...
sohl:
  ...
  items:
    ...
    - { model: skill-thuravarkscript, system: { masteryLevelBase: 48 } }
    ...
    - { model: sohl-sohl-skill-mill, system: { masteryLevelBase: 10 } }
