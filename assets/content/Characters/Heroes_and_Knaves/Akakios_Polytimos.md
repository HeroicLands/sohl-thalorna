...
img: images/beings/characters/akksplytms-portrait.webp
type: being
data:
...
sohl:
  ...
  items:
    ...
    - { shortcode: SgCap, type: armorgear }
    - name: Sailor’s rope (coiled)
      type: miscgear
      system:
        weight: 2
        quantity: 1
        value: 100
        durability: 3
    - name: Navigation tools (compass, astrolabe)
      type: miscgear
      system:
        weight: 0.5
        value: 8
        durability: 3
    - name: Fishing hooks and line
      type: miscgear
      system:
        quantity: 3
        weight: 1
        value: 100
        durability: 3
    - { name: Net (small), type: miscgear, system: { weight: 1, value: 100, durability: 3 } }
...
- **Swimming Excellence**: A natural affinity for water and exceptional swimming ability (14 base) that has saved his life more than once and grants him comfort in situations others find terrifying.
- **Fishing Expertise**: Beyond mere subsistence, his fishing knowledge borders on the intuitive, allowing him to locate and harvest fish in conditions others consider hopeless.
...
- **Resistance to Authority**: Akákios respects competence and follows those who prove themselves through demonstrated skill, but he chafes under arbitrary orders or leadership he considers undeserved.
...
2. **Wrecked Legacy**: Akákios encounters **Captain Merillos** in desperate circumstances—his vessel has been sabotaged, his crew scattered, and mysterious enemies pursue him. Merillos refuses to explain the circumstances but implores Akákios to help him hide a sealed cargo and disappear into anonymity. Akákios must choose between loyalty to his mentor and his own safety, all while discovering that Merillos may not be the man he always believed him to be.

3. **The Philosopher's Question**: A learned scholar from the interior cities hires passage aboard a League vessel to gain access to maritime archives Akákios uses for his research. The scholar becomes fascinated by Akákios's journals, recognizing in the ship designs the mathematical principles underlying an ancient text the scholar is attempting to decode. Together, they begin to realize that Akákios's intuitive designs may hold the key to understanding a lost civilization's navigational secrets—attracting interest from parties both academic and dangerous.

4. **Crew Rebellion**: Akákios assumes temporary command of a merchant vessel when the captain falls gravely ill. A portion of the crew, led by a charismatic mutineer, questions his authority and attempts to redirect the ship toward piracy. Akákios must navigate the delicate balance between maintaining order without unnecessary bloodshed, protecting the vulnerable crew members who remain loyal, and reaching port where legitimate authority can address the situation.

5. **The Cursed Trade**: A wealthy merchant hires Akákios for what should be a routine transport mission, but the voyage becomes increasingly strange—supplies spoil despite proper storage, sailors report uncanny sounds in the hold, and navigational instruments malfunction repeatedly. Akákios's practical mind struggles to find rational explanations, yet the evidence suggests something genuinely unnatural may be aboard. He must investigate whether the cargo itself carries a curse, whether a passenger harbors dark intentions, or whether forces beyond understanding have targeted the vessel.
