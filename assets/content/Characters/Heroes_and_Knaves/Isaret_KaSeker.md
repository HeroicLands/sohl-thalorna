...
sohl:
  ...
  items:
    ...
    - { model: skill-demtkscrpt, system: { masteryLevelBase: 56 } }
    ...
    - { model: sohl-sohl-skill-thtcs, system: { masteryLevelBase: 42 } }
    ...
    - { model: sohl-sohl-skill-lgdm, system: { masteryLevelBase: 75 } }
    ...
    - name: Rope and grappling hook
      type: miscgear
      system:
        shortcode: ropeandgrapplinghook
        weight: 0.5
        value: 100
        durability: 3
