...
sohl:
  ...
  items:
    ...
    - name: Tribal necklace (bone and silver, leadership insignia)
      type: miscgear
      system:
        shortcode: tribalnecklace
        value: 10
        weight: 1
        durability: 3
    - name: Hunting knife (bone handle)
      type: miscgear
      system:
        ...
        value: 100
        durability: 3
    - name: Territorial maps and survey notes
      type: miscgear
      system:
        shortcode: territorialmaps
        weight: 0.5
        value: 100
        durability: 3
    - name: Herbal remedies (wound treatment)
      type: miscgear
      system:
        ...
        weight: 1
        durability: 3
    - name: Leadership seal (carved bone)
      type: miscgear
      system:
        shortcode: leadershipseal
        value: 5
        weight: 1
        durability: 3
...
- **Master of Folklore and Law**: Her deep knowledge of tribal traditions, songs, and ancestral rulings allows her to navigate political disputes with the authority of precedent, even when proposing innovations.
