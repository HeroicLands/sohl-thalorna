...
sohl:
  ...
  items:
    ...
    - { model: skill-semrnscrpt, system: { masteryLevelBase: 64 } }
    ...
    - { model: sohl-sohl-skill-mnrl, system: { masteryLevelBase: 75 } }
    ...
    - name: Leather satchel with alchemical vials
      type: miscgear
      system:
    ...
    - name: Collection of glass vials and bottles
      type: miscgear
      system:
        shortcode: collectionofglass
        quantity: 20
        weight: 1
        value: 100
        durability: 3
    - name: Alchemical texts and formulas
      type: miscgear
      system:
        shortcode: alchemicaltexts
        weight: 1
        value: 100
        durability: 3
    - name: Mineral samples and reagents
      type: miscgear
      system:
        shortcode: mineralsamples
        weight: 1
        value: 100
        durability: 3
...
Dómrithâs is consumed by his obsession to the point where it has cannibalized his humanity. He speaks rarely of anything outside his work, and conversations with him quickly circle back to theories of transformation, decay, and the possibility of transcending mortality. His moral framework has become increasingly elastic—he can rationalize almost any action if it serves his pursuit of immortality, creating a dangerous incoherence between his claims of scientific dedication and his actual willingness to engage in genuine atrocities.

Yet moments of clarity still surface, usually when he is reminded of his sister or when his work produces results that unsettle even his expanded ethical boundaries. In those moments, flashes of his original nature emerge—a capacity for genuine warmth, intellectual humility, and horror at what he has become. These moments, however, are increasingly rare and quickly suppressed beneath renewed obsession.

His interaction style is professorial and condescending to those he considers intellectually beneath him, which encompasses most living humans. He reserves genuine engagement for those who demonstrate significant knowledge or willingness to serve his purposes, though even those relationships are fundamentally transactional.

### Motivation

Dómrithâs is ostensibly motivated by scientific pursuit—the genuine desire to expand human knowledge and achieve something that has always been assumed impossible. But beneath this lies a more personal and darker truth: he is driven by grief and guilt. His inability to save his sister created a wound that has never healed, and his pursuit of immortality is fundamentally an attempt to resurrect her, to create a world where her death becomes reversible, where all death becomes reversible, where his failure to save her is retroactively made not to matter.

There is also a will-to-power beneath his stated goals—a desire to become something more than human, to transcend the limitations that constrain ordinary existence, to achieve a kind of godhood through knowledge and transformation. This messianic conviction has gradually become more prominent as his work continues, creating a personality increasingly unstable and dangerous.

### Strengths

- **Alchemical Mastery**: His understanding of chemical transformation and material interaction is genuinely exceptional, capable of producing results that orthodox alchemists consider impossible or merely theoretical.
...
- **Medicinal Understanding**: His knowledge of herbs, poisons, and pharmaceutical compounds is encyclopedic, making him capable of diagnosing and treating conditions that baffle conventional physicians.

### Weaknesses

- **Moral Corruption**: His willingness to conduct experiments on unwilling subjects, test untested substances on vulnerable people, and ignore ethical constraints has made him profoundly dangerous and created powerful enemies.
- **Obsessive Tunnel Vision**: His fixation on immortality has blinded him to the genuine breakthroughs he is achieving in conventional alchemy, and his inability to work on anything outside his obsession has isolated him professionally.
- **Increasing Instability**: Extended exposure to his own experimental substances and the psychological weight of his obsession have begun manifesting in signs of genuine mental illness—paranoia, irrational convictions, dangerous mood fluctuations.
...
4. **The Exposed Experiments**: **Master Alchemist Theron** finally succeeds in publicly exposing Dómrithâs's experiments, revealing evidence of the unwilling subjects he has used, the deaths resulting from his work, and the moral bankruptcy of his research. The revelation triggers a formal guild investigation and criminal proceedings. Dómrithâs must choose between fleeing (losing his labs and resources), attempting to defend himself (nearly impossible given the evidence), or accelerating his work in hopes of producing a breakthrough significant enough to justify his methods or powerful enough to protect him from consequences.
