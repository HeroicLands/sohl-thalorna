...
sohl:
  ...
  items:
    ...
    - { model: skill-demtkscrpt, system: { masteryLevelBase: 13 } }
    ...
    - name: Quiver (leather, reinforced)
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Climbing rope and grappling hook
      type: miscgear
      system:
        shortcode: climbingrope
        weight: 1.5
        value: 100
        durability: 3
    - name: Map of trade routes (caravan paths)
      type: miscgear
      system:
...
2. **Meshara's Final Message**: Sênta's old mentor, scout master Meshara Arrowfinder, sends word that she is dying and has hidden something important in the Shattered Peaks—a location only Sênta knows how to reach. When Sênta finally retrieves Meshara's package, she finds evidence of a conspiracy within the Mercenaries' Guild itself, with high-ranking officials colluding with bandit organizations to orchestrate robberies and collect insurance payments. Now Sênta must decide whether to expose the corruption and destroy the guild she helped build, or remain silent and risk her integrity.
