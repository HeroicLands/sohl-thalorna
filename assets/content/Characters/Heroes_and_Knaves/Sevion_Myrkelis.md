...
sohl:
  ...
  items:
    ...
    - name: Alchemical satchel with crucibles and vials
      type: miscgear
      system:
        shortcode: alchemicalsatchel
        weight: 2
        value: 100
        durability: 3
    - name: Dried herbs and plant specimens (bundle)
      type: miscgear
      system:
        shortcode: driedherbsandplant
        weight: 1.2
        value: 100
        durability: 3
    - name: Bottles of prepared tinctures and extracts
      type: miscgear
      system:
        shortcode: bottlesofprepared
        weight: 1.5
        value: 100
        durability: 3
    - name: Brass scales and measuring weights
      type: miscgear
      system:
        shortcode: brassscales
        weight: 0.6
        value: 100
        durability: 3
    - name: Leather-bound alchemical journal
      type: miscgear
      system:
    ...
    - name: Mortar and pestle (stone)
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Oil lamp and stand
      type: miscgear
      system:
        shortcode: oillampandst
        weight: 0.8
        value: 100
        durability: 3
...
- **Dexterity**: His work with delicate alchemical compounds requires precision and a steady hand.
- **Agility**: Sevion moves with moderate agility, typical of someone who must frequently adjust to the shifting dynamics of his craft.
- **Perception**: His constant search for subtle details in his experiments has honed his perception to an acute level.
- **Comeliness**: His appearance, while not unattractive, is unremarkable.
- **Aura**: Sevion’s connection to the metaphysical manifests in his ability in arcane lore and grants him a subtle, compelling presence.
- **Will**: His single-minded pursuit of alchemical mastery has made him determined and resolute in his goals.
- **Reasoning**: Sevion possesses a keen, analytical mind capable of solving complex problems.
- **Creativity**: His work requires ingenuity, and he frequently develops new approaches to old alchemical problems.
- **Empathy**: While Sevion understands emotions intellectually, he often struggles to connect deeply with others on a personal level.
- **Eloquence**: Sevion communicates effectively but without great flair or charm.
