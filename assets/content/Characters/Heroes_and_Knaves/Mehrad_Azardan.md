...
type: being
data:
  portrait: images/beings/characters/mehradzrdn.webp
...
sohl:
  items:
    ...
    - { model: skill-dnshkscrpt, system: { masteryLevelBase: 24 } }
    ...
    - name: Measuring instruments (sextant, scale)
      type: miscgear
      system:
        shortcode: measuringinstruments
        weight: 1
        value: 100
        durability: 3
...
- **Resourcefulness Under Pressure**: When circumstances deteriorate and conventional solutions fail, Mehrâd's mind remains clear; he improvises brilliant solutions to seemingly impossible problems.
...
- **Emotional Unavailability**: His intense focus on accomplishment and danger-seeking has left him emotionally isolated; he struggles to maintain meaningful relationships or trust others with emotional vulnerability.
...
2. **The Lost Pilot's Map**: Mehrâd discovers a weathered navigation map in the possession of an elderly sailor, supposedly drawn by a legendary pilot from a century past. The map indicates a passage to a realm across the waters that no known navigator has reached—a place of legend and possibly impossible. The map's authenticity cannot be verified, but it offers exactly the sort of impossible challenge that Mehrâd cannot resist. The party becomes his crew as he assembles a vessel to make the attempt. Along the way, they discover that the map's origin and purpose may be far more sinister than a mere navigation challenge.

3. **The Pirate's Reckoning**: Khalid al-Rash finally makes his move against Mehrâd, publicly challenging him to a competitive navigation trial where the loser agrees to retire from piloting permanently. The competition draws massive gambling interest and intense attention from the maritime community. As the competition unfolds, the party discovers that Khalid has sabotaged the course itself, creating genuine danger that extends beyond simple competition. The trial becomes a test of whether skill and courage can overcome deliberate treachery.

4. **The Storm Born From Heaven**: An unprecedented storm emerges on the horizon—one that appears to defy natural meteorological explanation. As it approaches, Mehrâd realizes that his instincts, always so reliable, are providing contradictory information. Whatever this phenomenon is, it appears to exceed even his extraordinary ability to predict and navigate weather. He must guide a fleet of vessels to safety while confronting the possibility that some forces exist beyond his capacity to overcome, and that surrender rather than stubborn persistence may be the only path to survival.

5. **The Corsairs' Bargain**: Khalid al-Rash captures Mehrâd and brings him before the Corsairs of the Burning Coast. Rather than execute him, they offer an extraordinary proposition: pilot a single vessel to complete a voyage so dangerous and complex that it has never been successfully attempted. If Mehrâd succeeds, he is released and all debts are forgiven. If he fails, he becomes their permanent captive, forced to pilot their raiding expeditions for life. The party must decide whether to help Mehrâd in this impossible endeavor or negotiate his release through other means. The voyage itself becomes a crucible that will either cement Mehrâd's legend or destroy him absolutely.
