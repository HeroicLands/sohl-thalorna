...
sohl:
  ...
  items:
    ...
    - { shortcode: shpw, type: skill, system: { masteryLevelBase: 75 } }
    ...
    - { shortcode: pilt, type: skill, system: { masteryLevelBase: 15 } }
    ...
    - name: Canvas tool bag with saws, chisels, planes
      type: miscgear
      system:
        weight: 3
        value: 100
        durability: 3
    - name: Blueprints and plans case (leather)
      type: miscgear
      system:
        weight: 1
        value: 100
        durability: 3
    - name: Measuring rope and chalk
      type: miscgear
      system:
        weight: 1
        value: 100
        durability: 3
    - name: Caulking tools and pitch
      type: miscgear
      system:
        weight: 1
        value: 100
        durability: 3
    - name: Timber grain samples (reference collection)
      type: miscgear
      system:
        weight: 1
        value: 100
...
Born in the maritime city of **Chrysamar** to a family of modest means, Grégoras showed early aptitude for mathematics and spatial reasoning. At age nine, his father apprenticed him to Master Shipwright **Kyros the Old**, the most renowned shipbuilder of the Byzarian coast. For twelve years, Grégoras absorbed everything—understanding timber grain and seasoning, learning to calculate displacement and hull stress, mastering the geometry of sails and balance. **Kyros** recognized exceptional talent and pushed the boy relentlessly, holding him to impossibly high standards.

**Rising Through the Guild Ranks**

By age twenty-one, Grégoras completed his journeyman's examination and began supervising construction crews. His first independent commission was a merchant vessel of modest size; he completed it three weeks ahead of schedule with superior craftsmanship, establishing his reputation for reliable excellence. Throughout his twenties and thirties, he ascended the guild hierarchy, taking on increasingly complex and prestigious projects. His design innovations—subtle improvements to hull shape, more efficient rigging arrangements, novel approaches to weatherproofing—became sought after by naval commanders and wealthy merchants alike.
...
- **Practical Craftwork Excellence**: His hands-on understanding of materials, his ability to manage complex multi-stage construction projects, and his quality control standards make him capable of ensuring flawless execution of even intricate designs.
...
- **Limited Diplomacy and Eloquence**: His scores in charm and eloquence (both 10) reflect his genuine discomfort with social niceties. He cannot charm patrons, schmooze with nobles, or sell himself effectively, leaving his marketing to others.
...
2. **The Sabotaged Masterwork**: Grégoras begins work on his intended masterpiece—a warship so advanced it will eclipse all previous designs and cement his legacy as the greatest shipwright of his age. However, he begins discovering subtle sabotage in his materials and designs—timber with hidden flaws, measurements that have been subtly altered, key workers who are being paid to introduce errors. He hires adventurers to identify the saboteur(s). Investigation leads to **Shipwright Stavros**, his rival, who has become desperate enough to commit sabotage rather than compete fairly. The resolution might involve preventing further sabotage, dealing with **Stavros** through legal or more violent means, or discovering that someone is using **Stavros** as a dupe in a larger conspiracy.

3. **The Cursed Timber**: A shipment of exceptionally high-quality timber arrives for Grégoras's current project—wood so superior that it seems almost supernatural in its properties. Too late, he discovers the wood is cursed or comes from a forbidden source. Workers begin reporting strange occurrences, accidents that shouldn't be possible occur during construction, and the timber itself seems to resist cutting and shaping. Grégoras must work with the party to determine the source and nature of the curse and either lift it or find alternative materials without losing the major contract. The investigation might reveal the timber came from a forest sacred to an ancient power, or that it was harvested using slave labor and dark rituals.

4. **The Naval Innovation Race**: The Byzarian League and a rival naval power are engaged in an escalating arms race of maritime technology. The League's Admiral **Theodosius** commissions Grégoras to design and build a warship incorporating revolutionary innovations that will provide overwhelming tactical advantage. However, the rival power simultaneously commissions the party (perhaps along with Grégoras's rival **Stavros**) to acquire the designs or the finished vessel before it can be deployed. The party becomes caught between competing factions, and the resolution determines which power will dominate maritime superiority for decades to come.

5. **The Retirement Dilemma**: As Grégoras approaches the age when he feels he must finally take on a successor and begin transitioning away from day-to-day work, he realizes his most talented protégé is planning to leave the trade entirely to pursue a different calling (love, adventure, political opportunity, etc.). Grégoras, terrified of seeing his legacy lost and unable to articulate his emotional attachment, becomes difficult and controlling, driving the protégé away faster. The party might be hired to convince the protégé to reconsider, to help Grégoras learn to let go, or to discover that the protégé has a legitimate reason for leaving that requires the party's assistance to resolve. Alternatively, the party might assist Grégoras in recruiting and training a new generation of ship builders capable of carrying forward his methods and vision.
