...
type: being
data:
  portrait: images/beings/characters/prynbrmndn.webp
...
sohl:
  items:
    ...
    - { model: skill-dnshkscrpt, system: { masteryLevelBase: 70 } }
    ...
    - { model: sohl-sohl-skill-jewl, system: { masteryLevelBase: 64 } }
    ...
    - name: Parchment and charcoal (drawing supplies)
      type: miscgear
      system:
        shortcode: parchmentandcharcoal
        weight: 1.5
        value: 100
        durability: 3
