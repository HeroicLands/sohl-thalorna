...
sohl:
  ...
  items:
    ...
    - name: Large wooden chest for tools and supplies
      type: miscgear
      system:
        ...
        value: 100
        durability: 3
    - name: Heavy-duty stitching and tent-making tools
      type: miscgear
      system:
        shortcode: heavydutystitching
        weight: 0.8
        value: 100
        durability: 3
    - name: Leather patches (assorted)
      type: miscgear
      system:
        shortcode: leatherpatches
        quantity: 2
        weight: 1
        value: 100
        durability: 3
    - name: Waxed thread (spools)
      type: miscgear
      system:
        shortcode: waxedthread
        quantity: 3
        weight: 1
        value: 100
        durability: 3
