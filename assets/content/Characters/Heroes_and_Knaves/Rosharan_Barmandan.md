...
type: being
data:
  portrait: images/beings/characters/rshrnbrmndn.webp
...
sohl:
  items:
    ...
    - { model: skill-dnshkscrpt, system: { masteryLevelBase: 64 } }
    - { model: sohl-sohl-skill-shpw, system: { masteryLevelBase: 80 } }
    - { model: sohl-sohl-skill-chrm, system: { masteryLevelBase: 33 } }
    - { model: sohl-sohl-skill-cmd, system: { masteryLevelBase: 39 } }
    - { model: sohl-sohl-skill-dscr, system: { masteryLevelBase: 42 } }
    ...
    - { model: sohl-sohl-skill-timb, system: { masteryLevelBase: 75 } }
    ...
    - name: Shipwright's tools (planes, saws, chisels, measuring)
      type: miscgear
      system:
        shortcode: shipwrightstools
        weight: 3
        value: 100
        durability: 3
    - name: Leather tool roll and belt
      type: miscgear
      system:
        shortcode: leathertoolroll
        weight: 0.8
        value: 100
        durability: 3
    - name: Scale drawings and ship plans (rolled parchment)
      type: miscgear
      system:
        shortcode: scaledrawingsandship
        weight: 1
        value: 100
        durability: 3
    - name: Whetstone
      ...
      system:
        ...
        value: 100
        durability: 3
    - name: Rope (hemp, various weights)
      type: miscgear
      system:
        shortcode: rope
        quantity: 3
        ...
        value: 100
        durability: 3
    - name: Boat-building nails and fasteners
      type: miscgear
      system:
        shortcode: boatbuildingnails
        weight: 1.5
        value: 100
        durability: 3
    - name: Sealing wax and ink (for drafting)
      type: miscgear
      system:
        shortcode: sealingwaxandink
        weight: 1
        value: 100
        durability: 3
...
**Mastering the Art:** Khalid was a strict but generous mentor who insisted that true innovation came only after complete mastery of tradition. For fifteen years, Rosharan studied traditional design, worked with ancient timber types, and learned to predict how wood would move, swell, and age. However, by her late twenties, she began questioning established practices—suggesting innovations in hull design that improved speed, modifications to rigging that gave better wind-catching capability, and radical ideas about incorporating materials from distant lands. Her suggestions initially met resistance from Khalid himself, but gradually, he became her greatest advocate, eventually declaring her his successor and recommending her for Guild membership.
...
- **Timber Mastery:** Her timber-craft expertise (15 base, 5 focuses) gives her unparalleled understanding of wood properties, aging, and treatment. She can coax the best qualities from every timber source.
- **Practical Engineering:** Her broad array of complementary skills—drawing (15), metalcraft (14), woodworking (14, 4 focuses), ceramics (14), and masonry (14)—allow her to oversee every aspect of ship construction without relying on inferior subcontractors.
...
- **Insufficient Crew Management:** While her command (13) is respectable, it is her weakest social skill, and her relative indifference to crew comfort or working conditions has led to labor disputes and employee turnover.
- **Limited Mysticism:** Her low spirit (12) means she cannot work with magically-enhanced vessels or enchanted materials, limiting her ability to serve clients seeking supernatural vessels.
...
2. **The Experimental Warship:** The Royal Survey Corps commissions Rosharan to design a revolutionary deep-water warship incorporating her latest innovations—but midway through construction, agents from a rival nation begin sabotaging the project. Rosharan suspects an inside agent but cannot identify them. She hires adventurers ostensibly as security but actually to investigate the sabotage network. The twist: the saboteur is someone she trusts, and the adventurers must convince her to accept a painful betrayal.

3. **The Reaver's Ship Reborn:** Rosharan's stolen vessel surfaces in harbor under Reaver control. Rather than attempt a direct assault, she contracts adventurers to infiltrate the pirate crew, learn their current modifications to her design (which she finds both inspiring and horrifying), and ultimately help her reclaim the ship. The vessel has actually become faster and more dangerous under the Raiders' modifications, and Rosharan must grapple with the fact that her creation has found purposes—and glory—in criminal hands.

4. **The Sunken City Expedition:** Scholars contact Rosharan to design a specialized deep-water vessel capable of exploring submerged ruins rumored to exist far offshore. The project is ambitious and costly, requiring adventurers to gather rare materials from dangerous locations—depths where sea creatures of legendary size dwell, high mountains where special hardwoods grow, and mysterious caves where enchanted shells are found. As the team gathers materials, they uncover evidence that the "sunken city" is actually an ancient enemy of the Sultanate, and reaching it first matters more than they initially understood.

5. **The Timber of Prophecy:** An enigmatic merchant offers Rosharan a shipment of miraculous timber from a far-distant land—wood that is lighter than air-wood yet harder than ironbark, wood that glows faintly at night and seems to resist rot and decay. The merchant demands a substantial advance payment, and when Rosharan's adventurer partners investigate the timber's origin, they discover it comes from a forest that should not exist. The grove is protected by ancient spirits, and harvesting more timber requires negotiating with forces that are not entirely convinced humans deserve such bounty.
