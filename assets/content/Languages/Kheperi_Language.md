...
category: language
package: thalorna
language_family: Kheperi (isolate)
...
Kheperi possesses a distinctive consonantal inventory with several features that create its characteristic timbre:
...
Kheperi distinguishes three cardinal vowels, each with short and long variants:
...
Kheperi follows a **Verb-Subject-Object (VSO)** order in narrative clauses, though marked deviations occur in dependent clauses and nominal sentences.
...
Around 800 years ago, the widening gap between the laborious sacred script and the practical needs of administration led to the development of Demotic Kheperi. While structurally identical to Classical Kheperi, Demotic represents an orthographic reform rather than a linguistic one. However, its rapid adoption by the merchant class and administrative bureaucracies has gradually introduced vernacular features into what is written, accelerating the divergence between formal and colloquial speech.

### Modern Divergence

The spoken vernaculars of contemporary Kheperia show considerable divergence from Classical Kheperi:
...
Yet religious conservatism has resulted in Classical Kheperi being actively reinforced through education and ritual. The priesthood has successfully resisted reforms that would modernize the written system, maintaining the sanctity and untranslatability of the sacred texts.

## Regional Dialects

### Kheperian Proper (Core Regions)

- Closest to Classical Kheperi; emphatic consonants are well-maintained
...
- Moderate divergence from Classical Kheperi
...
- Examples: _Khâfirah_ (the bold one), _Thûtmêsu_ (moon-born)
...
- Examples: _Ankh'esna_ (life-bearer), _Senya_ (fortunate), _Tiya_ (gift)

**Clan or House Names:**

- Typically elaborate compounds referencing mythological ancestors, founders, or place names
...
- Examples: _Amen'rê_ (house of the sun-lord), _Ta'Seken_ (land of the ancestral realm), _Per'Ankhra_ (temple of the living)
