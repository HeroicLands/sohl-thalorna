...
At its core, Lëivōr holds that the universe is sustained by **Lëi** — the raw cosmic energy that flows through all classified things. Lëi is what gives the Great Sorting its permanence. It is the force that keeps fire behaving as fire, water as water, wood as wood. Without Lëi flowing through the classification system, the sorted world would dissolve back into the **Hürnlëi** — the primordial chaos of the Unclassified.
...
The Tānvüri model is **administrative**. They understand Lëi as the energy that _maintains classifications_ — the force that keeps sorted things in their categories. This model produces genuine insights that other traditions miss, and genuine blind spots that other traditions do not share.
...
The **Sorted World** is everything that was classified during the Great Sorting — the elements, the creatures, the spirits, the physical laws, the celestial bureaus. It encompasses both the mortal plane and the celestial plane, because both are products of classification. The gods and the mortals exist in the same sorted system; the gods are simply classified at a higher administrative level.
...
**Lëng** (Bright Flow) — the tendency of Lëi toward classification, differentiation, and order. Lëng energy sorts, distinguishes, and strengthens boundaries between categories. It is associated with clarity, authority, and the daytime.

**Hëk** (Dark Flow) — the tendency of Lëi toward dissolution, merging, and return to the undifferentiated. Hëk energy blurs boundaries, dissolves distinctions, and loosens classifications. It is associated with dreams, ambiguity, and the nighttime.

Neither flow is good or evil. Both are necessary. A cosmos of pure Lëng would be frozen — perfectly classified but unable to change, grow, or adapt. A cosmos of pure Hëk would be the Hürnlëi — formless potential without structure. The proper function of the cosmos requires both flows in balance, which is why the Bureau of Entropy (Hürn Sëi) exists despite its dangers.
...
3. **Earth (Tūr):** The domain of stability, foundation, and persistence. Earth holds classifications in place. It is the resistance to change, the inertia of the sorted world. Governed by Dāktūr Vōrthāt.

4. **Metal (Jīk):** The domain of distinction, boundary, and enforcement. Metal draws the sharp lines between categories — the blade that separates one classification from another. It is the domain of law, judgment, and precision. Governed by Vōrjīk Jëk.
...
6. **Spirit (Vōrlëi):** The domain of the intangible — soul, consciousness, and the administrative connection between mortal and celestial planes. Spirit is the medium through which petitions are filed and celestial directives received. This domain is governed collectively by the celestial bureau system, particularly the Ministry of Final Account ([[affiliation-tngvkvnlei|Sīkvōk]]) and the Bureau of Night Counsel ([[affiliation-tngvkvnlei|Mëi Sëi]]).

7. **Neutral (Hōk):** The domain of pure Lëi — the unclassified energy that predates sorting, represented by Tānlüng himself. This domain is paradoxical: it is the unsorted energy that sustains the sorted system. Practitioners who work with neutral Lëi are reaching beneath the classification system to touch the raw cosmic force directly, which is both immensely powerful and profoundly dangerous. No bureau administers this domain. No official holds this portfolio. It is Tānlüng's alone.
...
**Strengths of the bureaucratic model:**

- Exceptional at large-scale, coordinated workings (multiple practitioners filing on the same petition)
- Highly reliable once initiated (built-in procedural redundancies)
- Natural facility with wards, blessings, and long-duration effects (the bureaucracy processes slowly but persistently)
- Seamless integration with the spiritual economy (a magical working and a temple petition use the same mental architecture)

**Weaknesses of the bureaucratic model:**

- Slow to initiate compared to geometric or intuitive models (the form is elaborate)
- Poor at improvisation and rapid-response casting (there is no form for "unauthorized action")
- Categorical blindness — effects that cross jurisdictional boundaries or that no bureau governs are genuinely harder to produce
- Dependent on the practitioner's belief in the system — a Vëndük who loses faith in the celestial bureaucracy may find their forms literally disintegrating
...
**Meridians and Classification Channels.** The body contains channels through which Lëi flows, corresponding to the seven domains. Physicians (the **Yātvōr**) are trained to diagnose which classification channel is disrupted and to apply treatments that restore proper sorting. Acupuncture is understood as the _precise re-drawing of classification boundaries_ within the body. Herbal medicine works by introducing substances whose elemental classification compensates for imbalances.

**Elemental Organ Correspondences:**

- **Air (Lëi):** Lungs and respiratory system — the channels of communication and breath
- **Fire (Höt):** Heart and circulatory system — the engine of transformation
- **Earth (Tūr):** Spleen and digestive system — the foundation of stability
- **Metal (Jīk):** Liver and immune system — the boundaries that distinguish self from other
- **Water (Shüt):** Kidneys and urinary system — the channels of flow and transition
- **Spirit (Vōrlëi):** Mind and soul — the administrative center

**The Hierarchy of Healers:**

- **Thëizhëit** (Students): Apprentices in training
- **Yātgüng** (Practitioners): Experienced healers who run their own apothecaries
- **Dākyāt** (Master Physicians): Senior healers with deep understanding of Lëi
- **Vōryāt** (Grand Healers): The highest rank, capable of diagnosing spiritual as well as physical imbalances
