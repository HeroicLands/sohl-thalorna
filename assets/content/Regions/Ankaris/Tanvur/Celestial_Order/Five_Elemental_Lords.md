...
- **Bureau:** Administers the channels through which all classifications flow — the carrier medium that connects sorted things to each other and prevents the classified world from stagnating.

Vëngdāk Zhütvōr is the administrator of the Air domain, responsible for ensuring that Lëi flows between classifications rather than pooling or stagnating. In the bureaucratic model, wind is not a random atmospheric event — it is the _circulation of administrative energy_ through the classified world, maintaining the connections between sorted things. A windless day is not calm; it is a temporary slowdown in the system's circulatory network. A storm is a surge of processing throughput, not an act of wrath.
...
- **Bureau:** The Bureau of Transformation ([[affiliation-tngvkvnlei|Höt Sëi]]) — administers all processes that convert things from one classification to another, including the critical function of spirit-burning that transmits documents to the celestial filing system.

Röthöt Dākvëng governs the most practically important element in the classification cosmology: fire is the _medium of transmission_ between the mortal and celestial planes. Every spirit document burned, every offering transmitted, every petition filed through flame passes through his bureau's processing channels. Without the Bureau of Transformation functioning properly, the mortal plane would lose its administrative link to the celestial bureaucracy entirely.
...
- **Bureau:** Administers the classification of all stable, enduring material — stone, soil, minerals, and the structural foundations that keep sorted things in place.

Dāktūr Vōrthāt is the administrator of the Earth domain, responsible for the _persistence_ of classification. Where other elements govern change, flow, or transformation, Earth governs the resistance to change — the structural inertia that prevents sorted things from drifting out of their categories. Mountains do not stand because of natural law alone; they stand because Dāktūr Vōrthāt's bureau maintains their classification as solid, enduring, and _here_.
...
- **Bureau:** Administers the classification of boundaries and separations — the sharp lines between categories, the enforcement of distinctions, and the domain of law and judgment.

Vōrjīk Jëk governs the element that _draws the lines_. Metal is the domain of classification at its most precise: the blade that separates one category from another, the boundary that prevents sorted things from blurring together. This makes his bureau the elemental counterpart to the legal system — where the Tëng Lüt defines caste boundaries in law, Vōrjīk Jëk's bureau maintains those boundaries in the cosmic classification system.
...
- **Bureau:** Administers the classification of all processes involving flow, transition, and the movement of Lëi between categories — rivers, tides, the circulatory systems of living things, and the transitions between sorted states.

Zhütshüt Lüng governs the element that carries Lëi between classifications, enabling things to change from one sorted state to another without passing through the Unsorted. Water is the medium of transition — the domain that makes the classification system _dynamic_ rather than static. Without Water's bureau functioning, sorted things would remain frozen in their categories, unable to grow, change, or adapt.
