...
The census is conducted with obsessive thoroughness not because the empire is paranoid (though it is), but because the classification cosmology demands it. The Tānthëi teach that the Dāk Rën Thōk is the mortal shadow of the celestial Master Registry — and just as a lost record in the Archive of All Records would cause the thing it describes to slide toward the Hürnlëi, a person missing from the imperial census is a classification gap that weakens the cosmic order. Census officials who allow gaps in their records are not merely negligent — they are complicit in cosmic erosion.
...
The Zhāk Müt is not merely an administrative convenience. It is the physical proof that the bearer _exists within the sorted order_. A person without a Zhāk Müt, encountered outside their home region, is indistinguishable from the unclassified — and may be treated accordingly. Magistrates, garrison commanders, and commercial officials have the authority to demand inspection of the Zhāk Müt, and failure to produce one is grounds for detention until the bearer's classification can be verified through the registry.

The tablets vary in quality and elaboration by caste. A Zhëklüng's tablet is lacquered, gilt-edged, and bears multiple seals of authority. A Vüshōk officer's tablet includes their military rank and command jurisdiction. A Zāthük artisan's tablet records their guild affiliation and trade classification. A Nōkvür farmer's tablet is a plain wooden plaque with a single seal — functional, minimal, but present. Even the Nützōk carry tablets, though theirs record their owner rather than their own standing.
...
**Imperial Decree (Tëngzhëi Zhāklüt):** The Emperor, as the celestial bureaucracy's designated administrator, can classify a foreigner by direct decree. This is the highest form of classification — rare, prestigious, and usually reserved for foreign dignitaries, ambassadors, or individuals who have performed extraordinary service. An imperially classified foreigner is assigned a caste (typically Vüshōk for military allies, Tānthëi for scholars, or Zāthük for artisans), a provisional moral ledger is opened, and the bureaucratic machinery can process them. This is the Marco Polo scenario: a foreigner elevated by the personal patronage of the Son of Heaven, given standing that exists only so long as the Emperor wills it.

**Bureau Classification (Sëi Zhāklüt):** More commonly, foreigners are classified through the normal administrative channels — by the bureau or office whose jurisdiction their presence touches. A foreign merchant entering the empire to trade is classified by the commercial administration, which issues a **temporary trading classification** (Shükrën Dōk Thōk, roughly "Merchant Transit Document") that grants them Shükrën-equivalent standing for the duration of their business. A foreign physician offering their services might receive a temporary Zāthük classification through the local magistrate. These classifications are functional and limited — they allow the foreigner to operate within one narrow domain of the system, but they confer no broader standing. A merchant with a trading classification can buy and sell goods, but cannot petition a temple, file a legal claim outside of commercial disputes, or participate in civic life.
...
Even a foreigner with a bureau classification remains permanently marked as _other_. The classification is administrative, not ontological — the system processes them, but it does not _absorb_ them. Their moral ledger, if one is opened, begins at zero with no ancestral credit. Their petitions, if accepted, are processed at the lowest priority. Their children, if born in the empire, may be classified — but always with the notation that the lineage originates outside the sorted order. A classified foreigner is a sorted document in a foreign language: filed, but never fully read.
...
But within their own enclaves — the Sinalëan forest sanctuaries, the Khazárian mountain holds — the human classification system is irrelevant. The Sinalë and Khazári have their own understanding of their place in the world, their own spiritual traditions, their own social structures that long predate the Great Sorting (or at least, long predate the _human account_ of the Great Sorting). A Sinalo master craftsman classified as Zāthük would find the designation administratively useful and cosmologically meaningless. They are Sinalë. The paperwork is a human concern.
