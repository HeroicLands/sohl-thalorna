...
Some are **guardians** — created to protect a specific location, artifact, or sacred site, often long outlasting whatever they were set to watch over. Some are **hunters** — designed to find and destroy a particular threat, then left to their own devices once the task is complete (or abandoned mid-project). Some are **experiments** — the output of a celestial creative process that values novelty, a research project in flesh and bone that tests what a living thing can be made to do. And some have purposes that mortals have never been able to determine at all.

The creation forces do not value repetition. Making the same thing twice holds no interest. Every Dreadspawn is a one-off — a bespoke creation that represents a unique investment of divine creative energy. This is why they do not reproduce: reproduction would defeat the purpose. A reproducing species is a solved problem, a closed file. A Dreadspawn is an open project.
