...
data:
  ...
  governance:
    model: monarchy
    summary: >-
      Theocratic monarchy: a hereditary king who rules as a sacred figure, with the priesthood
      as the realm's second authority.
    ranks:
      - level: 0
        title: Outlaw
        description: >-
    ...
    offices:
      ...
      High Priest: Head of the realm's priesthood, who crowns the king and may refuse to.
      Royal Chaplain: Keeper of the king's own devotions and of the sacred character of his
        office.
...
The Holy Kingdom of Nartûm is an independent Vylari-speaking realm that shares cultural and linguistic roots with the [[doc-vylarinmpr|Vylarian Empire]] but maintains its own sovereignty under a theocratic monarchy. Where the empire's power rests on legions and senators, Nartum's rests on faith — the kingdom defines itself through its devotion to the [[affiliation-arldnpnthn|Aurèldían]] pantheon, and its king rules as a sacred figure blessed by the gods.
