...
Provenzians do not, on the whole, name their battles. They name the **ground**.
...
The battle is over. The field is still there, and still has to be walked past.

## What a Blood-field Is

An [[lore-aralwen|arálwen]] is a place where the material world and the spirit world lie naturally
thin against one another. A blood-field is not that. A blood-field is a place where the boundary was
**torn** — by a great many deaths in one place at one time — and did not close afterwards.

The distinction matters in every practical respect:

|              | **Arálwen**                              | **Blood-field**                         |
| ------------ | ---------------------------------------- | --------------------------------------- |
| Origin       | Natural; old beyond reckoning            | Made, at a datable moment, by slaughter |
| Character    | Takes its nature from the land — a _way_ | Takes its nature from the battle        |
| Stability    | Stable, and in its own manner orderly    | Unstable, and answerable to nothing     |
...
- **The Silence** — nothing sings there. No birds, no insects in summer, no sound but weather. Nothing
  is harmed and nothing will settle, and people who cross a silent field find they have walked faster
  than they meant to.
- **The Dread** — the field returns what was felt on it. Panic, rage, or a terrible unwilling
  steadiness comes over those who linger, and it does not announce itself as external. Commanders have
  known this for centuries, and the practice of manoeuvring an enemy onto a dreading field is old
  enough to have a name and disreputable enough to be denied.
- **The Withering** — rarest, and the one that ruins a district. The land dies: crops fail, beasts
  sicken, the soil goes sour and the sickness spreads outward. Only a handful are recorded, and the
  [[place-bldfldyharvalen|Blood-field of Yhârvalen]] is the one every Provenzian can name.

A field's resonance is fixed at the making and does not change on its own. Fields that have been
_worked on_ are another matter.
...
Since a blood-field is a permanent reservoir of violent death, it is precisely what the
[[affiliation-blackflame|Cult of the Black Flame]] wants, and the cult's interest in Provènzia is best
understood as an interest in its blood-fields. A field can be **worked on** — its resonance roused,
deepened, and turned from something a village lives beside into something that consumes the district.
That is what has happened at Yhârvalen.

There are a good many blood-fields in Provènzia, and there is no register of them. This is the single
strongest argument for making one, and the single strongest argument against.
