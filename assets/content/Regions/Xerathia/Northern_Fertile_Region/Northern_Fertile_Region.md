...
The region is shaped by a sharp **coastal-to-inland climate gradient** and, within that, by a single exceptional **river valley**.

The **coastal strip** along the Vylarian Sea is wet-coastal — citrus, grape, olive, fig, date-palm, and pomegranate flourish on sea-tempered winters and moderate summer heat. The cities of the coast are the region's oldest and most cosmopolitan, and the coastal strip has been the principal point of contact between Xerathia and the north for as long as the two continents have known each other. Bethua's northern coast, Ta'Kheperu's delta, and the western edge of Okháric territory share this character, though the strip is widest and most reliable in Bethua.

**Moving inland**, rainfall drops off sharply. Through most of the region, the middle and deep interiors are semi-arid grassland — productive only where water can be brought to it. Bethua and Ta'Kheperu have answered this with millennia of hydraulic engineering: aqueducts, tunnel qanats, cisterns, and canal networks whose maintenance employs tens of thousands of workers year-round and whose professional engineering corps are among the most prestigious institutions of their civilizations. Inside the irrigated strips, wheat, barley, millet, and legumes feed the dense urban populations; between them, open grasslands pasture sheep, cattle, and horses.
...
The three constituent polities are culturally distinct, united more by shared geography than by common identity:
...
Despite these differences, the region's peoples share a few deep features. The **Sep Tepy** chronological system, counted from the mythological founding of Kheperi civilization, is common coin across Ta'Kheperu and Okháris and has strongly influenced Bethuan dating despite the Matriarchy's formal independence of it. A **common set of trade languages** — pidgins built around Kheperi, Bethuan, and the Okháric dialects — is spoken in the river and caravan towns; most educated people of the region can make themselves understood anywhere within it. And a **shared vocabulary of water, herd, and festival** underlies local customs from the Kheperi flood-festivals to the Bethuan aqueduct-consecrations to the Okháric migration-rites, reflecting the common civilizational project of making habitable land.

## Religion

The region hosts three distinct religious traditions, each tied to one of the three polities and none dominant outside its home country:

- The **[[affiliation-kemtnpnthn|Kemetian Pantheon]]** — twelve great deities organizing the cosmos around the opposition of order and chaos, supported by a vast temple bureaucracy and an elaborate theology of death and renewal. Dominant throughout Ta'Kheperu.
...
Each of the three polities guards its independence carefully. There has never been a unified Northern Fertile Region; the closest thing to an imperial project was a short-lived Kheperi attempt, centuries ago, to bring the western temple-cities of Okháris into tributary relationship, which collapsed within a generation. The region's interstate politics have been characterized instead by:

- **Occasional border friction** between Bethua and Ta'Kheperu over the poorly-defined eastern frontier.
- **Pastoral-nomadic tribute relationships** along the southern margins of Bethua (where Okháric frontier clans pay tribute to Bethuan authorities in exchange for grazing rights) and along the western fringes of Ta'Kheperu (where steppe peoples maintain similar arrangements with Kheperi nomarchs).
