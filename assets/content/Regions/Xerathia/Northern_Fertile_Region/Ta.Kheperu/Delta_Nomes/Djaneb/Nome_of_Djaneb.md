...
data:
  governance:
    model: monarchy
    summary: >-
      A nome of the delta nomes governed by a hereditary Haty'a, who commands its levies,
...
Djaneb uses the [[lore-tkhprcrncy|Ta'Kheperu currency system]], with the local chapter of [[affiliation-perhati|Pér-Háti]] attached to its chief temple attesting the weight-pieces and holding the granary accounts. See [[lore-tkhprcrncy|Ta'Kheperu Currency]] for the full system.

## See Also

- [[affiliation-deltanomes|The Delta Nomes]] — Parent nome-class
- [[affiliation-empirtkhpr|The Empire of Ta'Kheperu]] — Imperial overview
- [[place-djaneb|Djaneb]] — Nome capital
