...
Per-Banit uses the [[lore-tkhprcrncy|Ta'Kheperu currency system]], with the local chapter of [[affiliation-perhati|Pér-Háti]] attached to its chief temple attesting the weight-pieces and holding the granary accounts. See [[lore-tkhprcrncy|Ta'Kheperu Currency]] for the full system.
