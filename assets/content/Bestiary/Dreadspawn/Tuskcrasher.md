...
img: images/beings/creatures/tskcrshr-portrait.webp
shortcode: tskcrshr
type: being
data:
...
sohl:
  ...
  items:
    ...
    - { shortcode: wil, type: attribute, system: { scoreBase: 20 } }
    ...
    - { shortcode: shok, type: skill, system: { masteryLevelBase: 63 } }
    - name: Goring Charge
      type: skill
      system:
        shortcode: gore
