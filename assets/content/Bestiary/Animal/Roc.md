...
type: being
data:
  portrait: images/beings/creatures/roc-portrait.webp
...
sohl:
  ...
  attrRollFormula:
    ...
    cre: 1d4+4
  items:
    - { shortcode: str, type: attribute, system: { scoreBase: 41 } }
    ...
    - { shortcode: shok, type: skill, system: { masteryLevelBase: 95 } }
