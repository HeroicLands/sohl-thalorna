...
sohl:
  ...
  items:
    ...
    - { shortcode: end, type: attribute, system: { scoreBase: 25 } }
    ...
    - { shortcode: wil, type: attribute, system: { scoreBase: 23 } }
    ...
    - { shortcode: stlth, type: skill, system: { masteryLevelBase: 95 } }
    - {
        shortcode: sprt,
        type: mysticalability,
        system: { masteryLevelBase: 57 },
      }
