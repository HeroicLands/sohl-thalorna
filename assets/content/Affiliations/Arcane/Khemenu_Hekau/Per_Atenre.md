  ...
  governance:
    ...
    ranks:
      - level: 0
        ...
        lore: excmmnctrnk
        description: >-
          Put out of the House and struck from its record. In a tradition where a name inscribed is a thing
          made real, the erasure is the sentence: the House keeps no account that the person was ever
          taught.
      - level: 1
        title: Wab of the House
        lore: initiaternk
        description: >-
          Learning the domain's names and the exact forms they take. A Wab of the House may recite under
          supervision and may not set anything down, because an inscription stands after the hand that made
          it has gone.
      - level: 2
        title: Hekau
        lore: professedrnk
        description: >-
          Holder of sacred power: permitted to speak the House's formulae and to inscribe them. The rank is
          the ordinary working practitioner, and in Ta'Kheperu it is held by priests rather than by any
          separate class of mage.
      - level: 3
        title: Kher-Heb
        lore: masterrnk
        description: >-
