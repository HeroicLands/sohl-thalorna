...
data:
  ...
  governance:
    ...
    offices:
      ...
      Wer'Hekau: >-
        The apex of a single cult; its authority does not extend beyond that cult.
      Hem'Netjer: >-
...
Every major temple in Ta'Kheperu follows the same three-rank hierarchy, a structure so ancient that the Kheperi consider it divinely ordained. The Per-Aá stands above all three ranks as the nominal supreme priest of every god — all temple authority flows downward from this claim.

- **Wer'Hekau** ("Great of Sacred Power") — the High Priest or High Priestess of a major temple, the supreme religious authority for a single cult. Each major temple has one Wer'Hekau who manages its vast holdings, speaks with the voice of the god, and conducts the great seasonal rites. The title carries enormous political weight.
