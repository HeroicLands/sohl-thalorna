...
name:
  ...
  aliases:
    ...
    - Höt Sëi
    - The Bureau of Transformation
shortcode: zhurhot
data:
  templatePriority: null
  demonym: null
  epithet: The Minister of Fire
  symbol: null
  governance:
    model: meritocracy
    summary: >-
    ...
    offices:
      ...
      Registrar: >-
        Keeps the region's ledgers and rules whether a petition is correctly addressed and supported
        by precedent.
      Seal-Holder: >-
        Holds the stamps this bureau requires; an unsealed petition is not a petition.
      Master of Forms: >-
        Holds the opening formulae and order of citation, and does not teach them outside the temple.
      Illuminator: >-
      ...
      Receiver of Tribute: >-
        Takes the sacrifice that pays a petition's carriage, and enters its value to the
        petitioner's credit.
      Advocate: >-
...
Höt Sëi administers transformation, and therefore administers the entire postal system of the
cosmos: fire is the medium by which a document passes from the mortal plane to the celestial one,
so every petition filed to every bureau is carried by this one. Burning a correctly addressed
petition actually files it; burning spirit money actually credits an account; burning offerings for
the dead actually provisions them.

This makes Zhürhöt structurally indispensable and personally unpopular. The other overseers resent
depending on a colleague to deliver their own mail, and the Tānthëi note that no bureau has ever
successfully petitioned to have the arrangement changed.
