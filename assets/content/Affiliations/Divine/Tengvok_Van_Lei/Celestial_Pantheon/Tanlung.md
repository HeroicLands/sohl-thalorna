...
data:
  ...
  governance:
    ...
    offices:
      ...
      Tānlüng: >-
        Tānlüng — The First Classifier — the being this bureau or cultus is organised around.
  commonSkills:
    - tanlung
    - tngthkscrpt
    - draw
...
In the beginning, before the drawing of any boundary, before the establishment of any category, was the **Hürnlëi** — undifferentiated chaos, raw potential without form or distinction. The Hürnlëi was not sentient; it was not hostile; it was not anything recognizable as a state of being. It was the absence of _being itself_, the negation of all possible categories.

Then came the **Vōr Thōk** (the First Distinction). At some moment that the Tānthëi acknowledge cannot be meaningfully described in sequential time — since time itself was only created afterward — Tānlüng drew the first boundary. Not gradually. Not through effort or creative will, but through the simple _act of classification_. The Vōr Thōk separated everything-that-is-above from everything-that-is-below. With that single distinction, existence bifurcated. The Hürnlëi did not vanish — it was pushed to the margins, contained within the structure that the First Distinction created, but never eliminated.
...
This means that an ambitious bureau overseer cannot appeal to Tānlüng for authority to expand their portfolio, cannot file a petition requesting reclassification of jurisdictional boundaries at the highest level. Tānlüng does not receive petitions. Tānlüng does not rule on precedent disputes. Tānlüng, quite simply, is not available for bureaucratic transaction.
...
The Hürnlëi remains. Tānlüng's Great Sorting did not eliminate chaos; it merely classified it and pushed it to the margins — into the spaces between categories, the paradoxes in the logical structure, the regions where the classification system has not yet been applied. The **Infernal Realms** exist in the Hürnlëi's wake — areas where the Great Sorting was incomplete, or has begun to unravel, or where the Demon Lords deliberately preserve the unclassified state as a refusal of Tānlüng's order.

The Bureau of Entropy (Hürn Sëi) exists, in part, to manage the boundary between the classified world and the encroaching Hürnlëi. But the bureau cannot expand this boundary, cannot push the Hürnlëi further back. The line between order and chaos is held, barely, through the eternal effort of countless functionary spirits administering ceaseless procedure. Were the bureaucracy to fail — were a major bureau to collapse, or the Jade Sovereign to be removed without proper succession — the Hürnlëi would begin reclaiming the sorted world, and classifications would begin to dissolve.
...
What mortals do is study. Scholars of the celestial order, members of the Tānthëi caste, petitioners seeking to understand the fundamental justice underlying a ruling that affects them — all of these may petition the Bureau of Knowledge (Thōk Sëi) for permission to access the archives containing the original classifications. To contemplate the Great Sorting is to catch a glimpse of Tānlüng's work, even if Tānlüng itself remains incomprehensible.

Some of the most devoted scholars have spent entire lives tracing the genealogy of a single classification — say, the original distinction between "water" and "fire," or the categories into which the human form was initially divided during the Great Sorting. To understand these primordial categories is believed to grant insight into how to petition the bureaus correctly, how to align one's actions with cosmic principle, how to avoid becoming _reclassified_ (the greatest terror in Tānvüri theology — to be re-sorted into a lower category, stripping one's ancestors of standing and one's descendants of privilege).
