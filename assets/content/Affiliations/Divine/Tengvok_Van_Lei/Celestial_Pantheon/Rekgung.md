  ...
  governance:
    ...
    offices:
      ...
      Intendant of the Bureau: >-
        Heads a Rëkshüt Sëi temple in a farming region or port city, and answers for its filings.
      Registrar of Allocations: >-
        Keeps the region-by-region rainfall ledgers against which every petition is checked.
      Seal-Holder: >-
...
The celestial calendar dictates when each region receives its annual rainfall, how many clear days are warranted in the growing season, when winter storms are scheduled to renew the soil. These allocations were established during the Great Sorting itself, codified into the celestial archives, and have been refined over tens of thousands of years of petition, adjustment, and reclassification. A region's rainfall is not a gift from Rëkgüng — it is a bureaucratic entitlement, allocated according to the region's spiritual classification, the moral ledger maintained by local ancestor spirits, and the historical precedent of previous allocations.
...
A region that grossly violates celestial norms — that commits crimes severe enough to incur official notice, that accumulates moral debts too large to be resolved through normal ancestor-spirit advocacy — may find itself subject to directed weather punishment. These are not random calamities but authorized strikes. A lightning storm that kills a specific tyrant, that floods the estates of a family engaged in systematic moral violation, that creates drought to starve out plague — these are execution orders transmitted through the bureau's administrative channels. The **Lëknëi** (Lightning Clerk) processes strike orders from higher authority, and the **Lüngzhük** (River Administrators) execute water-based punishments at the local level.
...
These petitions are filed through temples dedicated to the Bureau of Thunder and Rain, which exist in significant farming regions and all major port cities. The priest-clerks who staff these temples are trained in celestial bureaucracy — they know the correct forms, the required seals, the calendrical schedules, and the appeal procedures. They charge substantial fees for their service, as preparing a petition correctly requires expertise and often requires hiring scholars to research precedent.

Successful petitions are followed by the ritual burning of the petition-document, which transmits it to the celestial filing system. If the petition has merit and has been properly prepared, the Bureau of Thunder and Rain will process it and — if it does not conflict with other approved allocations — honor it. Rain will come according to the restored schedule.

Those regions that maintain close relations with ancestor spirits in favorable celestial positions benefit from what the Tānvüri call "bureaucratic advocacy" — ancestor spirits quietly lobbying the Bureau of Thunder and Rain on behalf of their living descendants, ensuring that petitions are processed speedily and that weather allocations remain favorable. Regions whose ancestor spirits have low standing find their petitions processed slowly, if at all, and their allocations reduced or redirected to higher-priority claims.
