...
data:
  ...
  governance:
    model: council
    summary: >-
      Authority rests with the individual priest on the road rather than with any chapter: the Dahana-Mūla is a rare rank, and most of the sect is itinerant, travelling alone or in pairs with an ember-vessel each.
    ranks:
      - level: 0
        title: Patita
        lore: excmmnctrnk
      ...
      - level: 3
        ...
        lore: priestrnk
        description: >-
          "Kindled One" — the ordinary priesthood: itinerant, typically travelling alone or in pairs, each carrying their own ember-vessel.
      - level: 4
        title: Dahana-Mūla
        lore: highpriestrnk
        description: >-
...
- **Bhasma** ("Ash") — novices, who serve a five-year probation of travel and work before being entrusted with a vessel of their own.
...
- **The Refreshing of the Ember** — the morning rite of every Jvālita; the ember in the carried vessel is fed and kept alive, with a brief prayer naming the fire's purpose for the day.
- **The Road-Blessing** — performed for a household that asks the priest's attention in passing; a simple purgation of the threshold and hearth, with a small fire kindled and then extinguished at the door.

**High Ceremonies:**

- **The Purgation** — the sect's signature rite. Conducted for an individual, a household, or a community. Involves a preparatory fast, a formal confession before the ember-vessel, and the burning of an object representing what is to be released. The rite may last hours or days depending on its subject.
- **The Scouring of the Temple** — an extraordinary rite performed, rarely and with reluctance, at the orthodox temple of a community the sect has judged corrupt. The Flame-priests process to the temple, kindle a fire at its threshold, and stay until the matter they have named has been addressed. Relations with the orthodox hierarchy are strained for years after.
