...
data:
  ...
  governance:
    model: council
    summary: >-
      The Two Powers are not petitioned and receive no offerings, so the pantheon has no clergy of
      its own: what standing exists is the standing of the Old Way, in which a shaman is recognised
      by their own tribe and answerable to it. There is no authority over the tradition as a whole,
      and no tribe's shamen bind another's.
    ranks:
      - level: 0
        title: Exiled
        lore: outlawrnk
...
At the heart of the First Gods stand two cosmic Powers. They are spoken of in pairs, in antitheses, and in song, but they are not petitioned, are not invoked by name in ceremony, and do not receive offerings of their own. They are treated less as persons than as principles — the great contending forces from which the world's order emerges. Áelendan shamen recognise both equally, and no Áelendan tribe takes one Power over the other.
...
The **Bright** is the power of light, life, growth, and the flame that keeps back the cold. The rising sun, the springing shoot, the hearth-fire that turns a mountain shelter into a human dwelling — all of these are the Bright's work. The Bright is not a person in the sense that the [[affiliation-arldnpnthn|Aurèldían]] gods are persons; the Áelendan do not speak of the Bright's will, or the Bright's history, or the Bright's family. The Bright is an aspect of the way the world is, and it is spoken of as one speaks of the sun or the weather: as a great present reality that shapes one's life without being personally interested in it.

What the Bright favours can be inferred from what the Bright is. Warmth, generation, the quickening of green things, the courage to act, the light that reveals what would otherwise be hidden, the visible order of a world that turns without fail. These are the Bright's character.
...
The **Dark** is the power of darkness, death, stillness, and the deep places of the earth. The setting of the sun, the fallen leaf returning to the soil, the stone beneath the soil that holds everything the world has ever been — all of these are the Dark's work. Like the Bright, the Dark is not a person, and the Áelendan speak of it in the same impersonal idiom: not the Dark's will but the Dark's character; not the Dark's history but the Dark's presence.

What the Dark favours can be inferred from what the Dark is. Silence, stillness, the cold that preserves rather than kills, the depth that holds. The long memory of stone. The receiving earth that takes back what has grown. The night in which the world rests. The dream that the sleeper cannot recall. These are the Dark's character. The Dark is also the power of what is hidden — the root, the seed in the soil, the unborn and the long-dead.

The Áelendan do not fear the Dark in the way that outsiders might expect. They respect it. To the Áelendan, fearing the Dark is much like fearing the winter: foolish, because the winter is coming regardless, and because the winter is necessary. What the Áelendan fear is transgression against the Dark — the grave broken open, the stillness of a sacred place violated, the bones of the ancestors disturbed. These things are dangerous. The Dark itself is not.
...
The Kindred are not an abstract concept. They are, in Áelendan experience, as real and present as weather, and the shamen of the tribes are trained from childhood to perceive them, to speak with them, and to negotiate the terms of the Áelendan's presence on the land they share.
