...
**Pyréthos and Hydälis** — Fire and Water. Transformation through destruction against transformation through adaptation. Energy against flow. The most viscerally obvious opposition, and the one that produces the fiercest inter-Sodalitas rivalries. A Pyréthos mage perceives the world as a system of energies waiting to be released, intensified, or redirected; a Hydälis mage perceives the same world as a system of currents, cycles, and states in constant flux. Each finds the other's fundamental instinct — to burn or to flow — almost physically uncomfortable to emulate.

**Zephäris and Sidéros** — Air and Metal. The intangible against the orderly. Illusion and freedom against binding and precision. Zephäris mages prize subtlety, indirection, and the magic of what cannot be grasped; Sidéros mages prize exactitude, structure, and the magic of what can be shaped and held. Their opposition is less explosive than Fire and Water but perhaps more philosophically irreconcilable: it is a disagreement about whether reality is fundamentally fluid or fundamentally structured.

**Physéra and Pneuménos** — Earth and Spirit. The material against the immaterial. Body against soul. Physéra mages are rooted in the tangible — stone, growth, the body, the enduring — while Pneuménos mages reach beyond the material entirely into mind, spirit, and communion with otherworldly entities. Their opposition reflects the oldest question in philosophy: whether the real is what you can touch, or what you can think.
...
But the Dýnaris is not undifferentiated. The Ordo's doctrine is precise on this point: the Dýnaris manifests in six elemental qualities, and only six. These six qualities are the Eídmata. There is no Dýnaris that is not Pyréthos, or Hydälis, or Zephäris, or Physéra, or Sidéros, or Pneuménos. The Dýnaris is _always already_ one of the Six, in every place and at every moment, in proportions that vary by location, time, and circumstance. The cold sea pressing against a northern shore is rich in Hydälis; a forge at the height of its work radiates Pyréthos; a graveyard at midnight is dense with Pneuménos. To draw upon the Dýnaris is therefore always to draw upon one or more of the Eídmata — there is no other kind of arcane force to be had.

The practitioner's first and most essential skill is learning to _open a channel_ to the Dýnaris — to prick a hole in the dike and allow the force to flow. The metaphor is not casual. The force of magic behaves like water under pressure: it wants to flow, and it will flow as strongly as the channel permits. A small, carefully controlled opening produces a trickle — enough for minor workings, cantrips, and the cautious exercises of early training. A larger opening produces a torrent — the raw power needed for major magic, but also a force that can overwhelm and destroy the practitioner who cannot control it.

This is why the very first lesson every Initiatus receives is not a spell but a discipline: how to open a channel _small enough to manage_. The Ordo's teaching methodology is built on the principle that control precedes power. An Initiatus who learns to open a narrow, stable channel and hold it steady has learned the foundational skill upon which everything else depends. An Initiatus who opens too wide, too fast, discovers why the Ordo's training halls are warded against catastrophic arcane discharge — and why the infirmary is always nearby.
...
A mage's training in their Eídma teaches them to recognise their Eídma's current, to attune to it, to draw from it cleanly without disturbing the others. The deeper the training, the cleaner the attunement — and the harder it becomes to attune to any other current. This is the source of the oppositions and adjacencies described above: not perceptual artifacts, but real properties of the Dýnaris itself, manifesting in the practitioner's developing sensitivity to their chosen current.
...
The Morphís is a mental and spiritual construct — a pattern held in the practitioner's mind that gives structure to the raw flow of Dýnaris, the way a waterwheel gives purpose to a river's current. The waterwheel does not create the force; it channels the force to do useful work. A simple Morphís — the arcane equivalent of a crude wooden paddle in a stream — can harness a small flow to produce a simple, predictable effect: a spark of light, a puff of warmth, a minor ward. A complex Morphís — an elaborate architecture of interlocking mental structures, refined through years of study and practice — can harness enormous flows to produce effects of extraordinary subtlety and power.

The relationship between Dýnaris and Morphís is not merely additive but _structural_. A simple Morphís cannot handle a large flow of force any more than a wooden paddle can harness a flood — the force will shatter the form, and the resulting uncontrolled discharge is one of the most common causes of arcane accidents. Conversely, even the most sophisticated Morphís accomplishes nothing without sufficient Dýnaris to drive it — a waterwheel in a dry riverbed is merely an interesting sculpture. The practitioner must learn to match form to force: enough Dýnaris to power the Morphís, but not so much that the Morphís comes apart under the strain.

This is where the six Eídmata become essential. Each Eídma teaches its practitioners a _repertoire of Morphís_ — mental architectures tuned to that Eídma's current. A Pyréthos Morphís is shaped to channel Pyréthos force into heat, light, and energetic transformation. A Hydälis Morphís is shaped to channel Hydälis force into flow, adaptation, and healing. The Morphís and the current are matched: a Pyréthos form drawing on a Pyréthos current produces clean, predictable, powerful magic. Mismatched workings — a Pyréthos form attempting to channel Hydälis force — produce nothing useful, and often produce something dangerous. This is why a mage's Eídma matters so deeply: their Morphís repertoire is trained for one current, and the forms become deeply ingrained. A Pyréthos mage can construct Fire-aligned forms instinctively, with the ease of a native speaker forming sentences — but constructing a Water-aligned form requires thinking in a grammar that contradicts everything their training has taught them, _and_ being able to attune to a current they have spent their career learning to ignore.
...
1. **Reduction.** "Whatever they are doing, it must really be Pneuménos, or Pyréthos, or some combination — they simply call it by other names." The Ordo forces the foreign practice into its own categories, producing scholarly treatises that interpret every foreign tradition as a corrupted or partial version of the Héx Hodäi.

2. **Denial.** "It is not really magic. It is a trick, a debased folk practice, demonic interference, or sleight-of-hand dressed up in foreign costume." The Ordo refuses to recognise it as arcane at all.

3. **Suppression.** "It is heretical and dangerous, and must be controlled." The Quaesitorium is dispatched, where political conditions permit.

What the Ordo cannot do — what the framework structurally prevents it from doing — is recognise the foreign tradition as a legitimate alternative carving of a larger reality. The framework does not admit that there _is_ a larger reality. To accept the foreign tradition on its own terms would require dismantling the Héx Hodäi, and that is not an operation the Ordo is institutionally capable of performing.
...
- [[affiliation-kentra|Kentra]] — The mastery of all six Eídmata, and the affliction that sometimes follows
