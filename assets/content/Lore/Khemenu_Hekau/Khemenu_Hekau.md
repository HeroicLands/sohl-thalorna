...
img: icons/takheperu/khemenu-hekau/khemenuhekau.svg
name:
  full: Khemenu Hekau
  aliases:
    - The Eight
...
**hekau**, those who hold sacred power; the title of every high priest in the empire —
**Wer'Hekau**, "Great of Sacred Power" — names the greatest of them.
...
reaching into it. The disagreement is about where its divisions lie.

The [[affiliation-ordoarcanis|Ordo Arcanis]] partitions the ocean by **substance**: fire, water, air,
earth, metal, spirit. Its doctrine is not that this is a serviceable model but that it is the
structure of arcane reality, that the Dýnaris is _always already_ one of the Six in every place and
at every moment, and that the Six exhaust the arcane.

The Kheperi partition the same ocean by **function in the cosmic order** — not by what a portion of
reality is made of, but by what it is _for_. Their eight domains are theological before they are
arcane, and the tradition makes no apology for that: in Ta'Kheperu the distinction between priest and
...
one, because neither set of lines is a subdivision of the other. A working in the Duat draws on what a
Magister would have to call Spirit and Earth at once; a working of the River spans his Water and his
Earth. This is the practical reason the traditions cannot see each other. An Ordo observer watching a
hekau does not see foreign magic — he sees **impure** magic, several Eídmata braided into a single
coherent act, which by his own doctrine should not be castable at all. And it works in front of him.

The Kheperi find the reverse just as absurd. To divide the arcane by material substance strikes them
as classifying a library by the colour of the bindings: true of the objects, and silent about what
any of it is for.

Neither priesthood is much troubled by the other's existence. The Ordo has no presence in Ta'Kheperu
...
This is the deeper reason the Kheperi regard western practitioners as half-educated, and the reason
...
kept in temple libraries open only to the initiated — so the act of magic is one of **correct
address**: the true name, in the exact form, spoken or set down.

Correctness is not a matter of care but of doctrine. A properly executed tomb painting does not depict
the afterlife; it _is_ the afterlife, made real through correct form. This is why Kheperi art is
conservative to a degree foreigners mistake for lack of skill — innovation in form is not undervalued
but actively dangerous, and perfection of the established form is the whole of the discipline.

Three practical consequences follow, and they mark Kheperi working out as unmistakable:

- **It is installed rather than cast.** The characteristic Kheperi working is inscribed and stands —
  seals, curses, wards, and the bound dead set to wake when a chamber is broken. Some have stood for
  six hundred years.
- **It is transferable through labour.** A correct inscription works for whoever set it correctly,
  which is why the craftsmen who cut the tombs are the most watched community in their nome, and why
  a tomb-robber's surest key is a bribed priest who knows which glyph is live and which is bluff.
- **Error does not fail; it executes.** A working that is wrong in its form is not inert. It does
