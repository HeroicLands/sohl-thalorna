...
- **Met through:** [[skill-mzazisprt|Mzazi wa Ardhi Spirit Power]], in the [[affiliation-njiayaroho|Njia ya Roho]]

Mzazi wa Ardhi governs fertility without distinguishing its kinds: the sown field, the
pregnant herd and the birthing-house are one domain, and the same cairn serves all three. This is
the zohira most Okhárics deal with most often, and the one whose observances are most thoroughly
woven into ordinary life rather than reserved to shamans.

A birth is attended by a shaman where one is available and by the household where one is not, and
the tradition is explicit that the household's rite is not a lesser substitute. Mzazi does not
...
watched by the neighbours with interest.
